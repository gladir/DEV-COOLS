...
; Source  : SAMPLES/CLOJURE/higher.clj
...
; (list ...)
        ...
        POP AX
        CALL _CLRT_CONS
        MOV WORD PTR [_CL_HFTMP2],AX
        MOV WORD PTR [_CL_HFTMP3],0
_CL_8:
        MOV SI,WORD PTR [_CL_HFTMP2]
        CMP SI,0
        JE _CL_9
        MOV AX,WORD PTR [SI]
        PUSH AX
        CALL    WORD PTR [_CL_HFTMP1]
        ADD SP,2
        MOV BX,WORD PTR [_CL_HFTMP3]
        CALL _CLRT_CONS
        MOV WORD PTR [_CL_HFTMP3],AX
        MOV SI,WORD PTR [_CL_HFTMP2]
        MOV SI,WORD PTR [SI+2]
        MOV WORD PTR [_CL_HFTMP2],SI
        JMP _CL_8
_CL_9:
        MOV AX,WORD PTR [_CL_HFTMP3]
        CALL _CLRT_LREV
        CALL _CLRT_LCOUNT
...
_CL_31:
        ...
        RET
_CL_32:
        MOV AX,OFFSET _CL_31
        MOV [_CLV_double_inc],AX
; (println ...)
; (double-inc ...)
        MOV AX,5
        PUSH AX
        CALL _CLV_double_inc
        ADD SP,2
        MOV SI,AX
        CALL _CLRT_PRINTSTR
        CALL _CLRT_WRITECRLF
...
_CL_35:
        PUSH BP
        MOV BP,SP
        MOV AX,WORD PTR [_CL_HFTMP1]
        MOV SP,BP
        POP BP
        RET
_CL_36:
        MOV AX,OFFSET _CL_35
        MOV [_CLV_toujours42],AX
; (println ...)
; (toujours42 ...)
        MOV AX,99
        PUSH AX
        CALL _CLV_toujours42
        ADD SP,2
        MOV SI,AX
        CALL _CLRT_PRINTSTR
        CALL _CLRT_WRITECRLF
...
_CL_SPACE  DB ' ',0
_CLK_1  DB 'hello',0
_CLV_double_inc  DW 0
_CLV_add10  DW 0
_CLV_toujours42  DW 0
