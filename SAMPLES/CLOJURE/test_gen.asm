...
; Source  : SAMPLES/CLOJURE/test_gen.clj
...
; (double ...)
        ...
        CALL _CLF_somme
        ADD SP,4
        MOV [_CLV_resultat],AX
; (println ...)
        MOV AX,[_CLV_resultat]
        MOV SI,AX
        CALL _CLRT_PRINTSTR
        CALL _CLRT_WRITECRLF
        XOR AX,AX
...
_CL_SPACE  DB ' ',0
_CLV_titre  DW 0
_CLK_1  DB 'Test TODO 25',0
_CLV_version  DW 0
_CLV_resultat  DW 0
_CLK_2  DB '=== -main appelee ===',0
_CLK_3  DB 'titre=',0
_CLK_4  DB 'version=',0
_CLK_5  DB 'double(7)=',0
_CLK_6  DB '=== fin -main ===',0
