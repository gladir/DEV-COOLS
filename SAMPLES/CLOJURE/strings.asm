...
; Source  : SAMPLES/CLOJURE/strings.clj
...
; (clojure.string/includes? s sub)
        MOV AX,OFFSET _CLK_14
        PUSH AX
        MOV AX,OFFSET _CLK_15
        MOV DI,AX
        POP SI
        CALL _CLRT_STRFIND
...
; (println ...)
; (clojure.string/includes? s sub)
        MOV AX,OFFSET _CLK_16
        PUSH AX
        MOV AX,OFFSET _CLK_17
        MOV DI,AX
        POP SI
        CALL _CLRT_STRFIND
        CALL _CLRT_PRINTBOOL
        ...
        XOR AX,AX
; (println ...)
; (clojure.string/replace s match repl)
        MOV AX,OFFSET _CLK_18
        PUSH AX
        MOV AX,OFFSET _CLK_19
        PUSH AX
        MOV AX,OFFSET _CLK_20
        MOV WORD PTR [_CL_SCTMP3],AX
        POP DI
        POP SI
        CALL _CLRT_STRREPL
        MOV SI,AX
...
; (println ...)
; (clojure.string/replace s match repl)
        MOV AX,OFFSET _CLK_21
        PUSH AX
        MOV AX,OFFSET _CLK_22
        PUSH AX
        MOV AX,OFFSET _CLK_23
        MOV WORD PTR [_CL_SCTMP3],AX
        POP DI
        POP SI
        CALL _CLRT_STRREPL
...
; (def items)
; (list ...)
        MOV AX,OFFSET _CLK_24
        PUSH AX
        MOV AX,OFFSET _CLK_25
        PUSH AX
        MOV AX,OFFSET _CLK_26
        PUSH AX
        XOR AX,AX
        MOV BX,AX
        POP AX
...
; (println ...)
; (clojure.string/join sep coll)
        MOV AX,OFFSET _CLK_28
        PUSH AX
; (list ...)
        MOV AX,OFFSET _CLK_29
        PUSH AX
        MOV AX,OFFSET _CLK_30
        PUSH AX
        MOV AX,OFFSET _CLK_31
        PUSH AX
        XOR AX,AX
        MOV BX,AX
        POP AX
...
_CLK_3  DB 'World',0
_CLK_4  DB 'abc',0
_CLK_5  DB 'Hello World',0
_CLK_6  DB 'Hello World',0
_CLK_7  DB 'Hello',0
_CLK_8  DB 0
_CLK_9  DB 'abcde',0
_CLK_10  DB 'abcde',0
_CLK_11  DB 'hello world',0
_CLK_12  DB 'HELLO WORLD',0
_CLK_13  DB '  espaces  ',0
_CLK_14  DB 'hello world',0
_CLK_15  DB 'world',0
_CLK_16  DB 'hello',0
_CLK_17  DB 'xyz',0
_CLK_18  DB 'hello world',0
_CLK_19  DB 'world',0
_CLK_20  DB 'clojure',0
_CLK_21  DB 'aaa',0
_CLK_22  DB 'a',0
_CLK_23  DB 'b',0
_CLV_items  DW 0
