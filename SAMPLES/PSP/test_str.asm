...
; Source : samples\PSP\test_str.psp
; ========================================
...
; assign s1
        LEA   AX, _PSPK_1
        MOV   WORD PTR [_PSP_S1], AX
; assign s2
        LEA   AX, _PSPK_2
        MOV   WORD PTR [_PSP_S2], AX
; assign s3
        MOV   AX, WORD PTR [_PSP_S1]
        PUSH   AX
        MOV   AX, WORD PTR [_PSP_S2]
        MOV   BX, AX
        POP   AX
        MOV   SI, AX
        MOV   DI, BX
        CALL   _PSPRT_CONCAT
        MOV   WORD PTR [_PSP_S3], AX
; write
        MOV   AX, WORD PTR [_PSP_S3]
        MOV   SI, AX
