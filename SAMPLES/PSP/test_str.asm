...
; Source : SAMPLES/PSP/test_str.psp
...
; assign s1
        LEA   EAX, _PSPK_1
        MOV   DWORD PTR [_PSP_S1], EAX
; assign s2
        LEA   EAX, _PSPK_2
        MOV   DWORD PTR [_PSP_S2], EAX
; assign s3
        MOV   EAX, DWORD PTR [_PSP_S1]
        PUSH   EAX
        MOV   EAX, DWORD PTR [_PSP_S2]
        MOV   EBX, EAX
        POP   EAX
        MOV   ESI, EAX
        MOV   EDI, EBX
        CALL   _PSPRT_CONCAT
        MOV   DWORD PTR [_PSP_S3], EAX
; write
        MOV   EAX, DWORD PTR [_PSP_S3]
        MOV   ESI, EAX
...
_PSPL_29:
        ...
        MOV   ESI, OFFSET _PSPRT_CHRBUF
        CALL   _PSPRT_PRINTSTR
; writeln
        MOV   ESI, OFFSET _PSPRT_CRLF
        CALL   _PSPRT_PRINTSTR
; html fragment
        MOV   ESI, OFFSET _PSPK_HTML_30
        CALL   _PSPRT_PRINTSTR
...
_PSPK_11  DB  'DIFF',0
_PSPK_12  DB  'xyz',0
_PSPK_16  DB  'NOTEQUAL',0
_PSPK_17  DB  'SAME',0
_PSPK_21  DB  'LESS',0
_PSPK_22  DB  'GREATEQ',0
_PSPK_23  DB  'A',0
_PSPK_24  DB  'B',0
_PSPK_25  DB  'C',0
_PSPK_26  DB  'Hello World',0
_PSPK_27  DB  'World',0
_PSPK_28  DB  'm',0
_PSPK_HTML_30  DB  '
',0
