...
_PSPK_5  DB  ']',0
_PSPK_6  DB  'abcdef',0
_PSPK_7  DB  'Delete(abcdef,3,2)=',0
_PSPK_8  DB  'abef',0
_PSPK_9  DB  'cd',0
_PSPK_10  DB  'Insert(cd,abef,3)=',0
_PSPK_11  DB  'Hello World',0
_PSPK_12  DB  'lower(Hello World)=',0
_PSPK_13  DB  'xyzabc',0
_PSPK_14  DB  'Delete(xyzabc,1,3)=',0
_PSPK_15  DB  'world',0
_PSPK_16  DB  'hello ',0
_PSPK_17  DB  'Insert(hello ,world,1)=',0
_PSPK_18  DB  'nospace',0
_PSPK_19  DB  'Trim(nospace)=[',0
_PSPK_20  DB  ']',0
_PSPK_21  DB  'Done',0
_PSPK_HTML_22  DB  '
',0
