...
; Source : SAMPLES/PSP/test_write.psp
...
; writeln
        ...
        CMP   EAX, 0
        JE   _PSPL_7
        MOV   ESI, OFFSET _PSPRT_TRUE_S
        JMP   _PSPL_8
_PSPL_7:
        MOV   ESI, OFFSET _PSPRT_FALSE_S
_PSPL_8:
        CALL   _PSPRT_PRINTSTR
        MOV   ESI, OFFSET _PSPRT_CRLF
        CALL   _PSPRT_PRINTSTR
