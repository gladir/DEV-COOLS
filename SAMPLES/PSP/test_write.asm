...
; Source : samples\PSP\test_write.psp
; ========================================
...
; assign name
        LEA   AX, _PSPK_3
        MOV   WORD PTR [_PSP_NAME], AX
; assign flag
        MOV   AX, 1
        MOV   BYTE PTR [_PSP_FLAG], AL
; write
        LEA   AX, _PSPK_4
        MOV   SI, AX
        CALL   _PSPRT_PRINTSTR
; writeln
        MOV   AX, WORD PTR [_PSP_NAME]
        MOV   SI, AX
        CALL   _PSPRT_PRINTSTR
...
; writeln
        ...
        CALL   _PSPRT_PRINTSTR
        XOR   AH, AH
        MOV   AL, BYTE PTR [_PSP_FLAG]
        CMP   AX, 0
        JE   _PSPL_7
        MOV   SI, OFFSET _PSPRT_TRUE_S
        JMP   _PSPL_8
_PSPL_7:
        MOV   SI, OFFSET _PSPRT_FALSE_S
_PSPL_8:
        CALL   _PSPRT_PRINTSTR
        MOV   SI, OFFSET _PSPRT_CRLF
        CALL   _PSPRT_PRINTSTR
...
<h1>Test TODO 12</h1>
',0
_PSPK_2  DB  'PSP86 Test',0
_PSP_TITLE  DW  OFFSET _PSPK_2
_PSP_X  DW  0
_PSP_NAME  DW  0
_PSP_FLAG  DB  0
_PSP_CH  DB  0
_PSPK_3  DB  'monde',0
_PSPK_4  DB  'Bonjour ',0
_PSPK_5  DB  'x = ',0
_PSPK_6  DB  'flag = ',0
_PSPK_9  DB  'Valeur: ',0
_PSPK_10  DB  ' ok',0
_PSPK_HTML_11  DB  '
<p>Fragment HTML entre blocs Pascal</p>
',0
_PSPK_12  DB  'Back in code',0
_PSPK_HTML_13  DB  '
<footer>
<p>Expression inline: ',0
_PSPK_HTML_14  DB  '</p>
<p>Const inline: ',0
_PSPK_HTML_15  DB  '</p>
<p>Bool inline: ',0
