...
; Source : samples\PSP\test_scope.psp
; ========================================
...
; call Swap
        MOV   AX, OFFSET _PSP_A
        PUSH   AX
        MOV   AX, OFFSET _PSP_B
        PUSH   AX
        CALL   _PSPF_SWAP
; write
...
; assign c
        MOV   AX, 5
        MOV   WORD PTR [_PSP_C], AX
; call Inc10
        MOV   AX, OFFSET _PSP_C
        PUSH   AX
        CALL   _PSPF_INC10
; write
        MOV   AX, WORD PTR [_PSP_C]
        CALL   _PSPRT_NUMTOSTR
        MOV   SI, OFFSET _PSPRT_NUMBUF
        CALL   _PSPRT_PRINTSTR
; writeln
...
; assign d
        MOV   AX, 100
        MOV   WORD PTR [_PSP_D], AX
; call AddTo
        MOV   AX, 50
        PUSH   AX
        MOV   AX, OFFSET _PSP_D
        PUSH   AX
        CALL   _PSPF_ADDTO
; write
        MOV   AX, WORD PTR [_PSP_D]
        CALL   _PSPRT_NUMTOSTR
        MOV   SI, OFFSET _PSPRT_NUMBUF
        CALL   _PSPRT_PRINTSTR
; writeln
...
_PSPL_5:
        ...
        POP   BP
        RET   2
_PSPF_DOUBLEVAR   ENDP


; --- CallDouble ---
_PSPF_CALLDOUBLE   PROC NEAR
        PUSH   BP
        MOV   BP, SP
        PUSH   SI
        PUSH   DI
...
_PSPL_6:
        ...
        POP   BP
        RET   2
_PSPF_CALLDOUBLE   ENDP

; assign e
        MOV   AX, 7
        MOV   WORD PTR [_PSP_E], AX
; call CallDouble
        MOV   AX, OFFSET _PSP_E
        PUSH   AX
        CALL   _PSPF_CALLDOUBLE
; write
        MOV   AX, WORD PTR [_PSP_E]
        CALL   _PSPRT_NUMTOSTR
        MOV   SI, OFFSET _PSPRT_NUMBUF
        CALL   _PSPRT_PRINTSTR
; writeln
...
; call hidden
        ...
        PUSH   AX
        CALL   _PSPF_HIDDEN
        MOV   WORD PTR [_PSP_F], AX
; write
        MOV   AX, WORD PTR [_PSP_F]
        CALL   _PSPRT_NUMTOSTR
        MOV   SI, OFFSET _PSPRT_NUMBUF
        CALL   _PSPRT_PRINTSTR
; writeln
