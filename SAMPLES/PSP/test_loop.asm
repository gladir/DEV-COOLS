...
; Source : samples\PSP\test_loop.psp
; ========================================
...
; for
        ...
        MOV   WORD PTR [_PSP_I], AX
        MOV   AX, 1
        MOV   WORD PTR [_PSPL_7], AX
_PSPL_8:
        MOV   AX, WORD PTR [_PSP_I]
        CMP   AX, WORD PTR [_PSPL_7]
        JL   _PSPL_9
; writeln
        MOV   AX, WORD PTR [_PSP_I]
        CALL   _PSPRT_NUMTOSTR
...
; for
        ...
        MOV   WORD PTR [_PSP_I], AX
        MOV   AX, 100
        MOV   WORD PTR [_PSPL_17], AX
_PSPL_18:
        MOV   AX, WORD PTR [_PSP_I]
        CMP   AX, WORD PTR [_PSPL_17]
        JG   _PSPL_19
; if
        MOV   AX, WORD PTR [_PSP_I]
        PUSH   AX
...
; for
        ...
        MOV   WORD PTR [_PSP_I], AX
        MOV   AX, 5
        MOV   WORD PTR [_PSPL_24], AX
_PSPL_25:
        MOV   AX, WORD PTR [_PSP_I]
        CMP   AX, WORD PTR [_PSPL_24]
        JG   _PSPL_26
; if
        MOV   AX, WORD PTR [_PSP_I]
        PUSH   AX
