...
; Source : samples\PSP\calculcalciumcorrige.psp
; ========================================
...
; --- CalculCalciumcorrige ---
_PSPF_CALCULCALCIUMCORRIGE   PROC NEAR
        PUSH   BP
        MOV   BP, SP
        SUB   SP, 2
        PUSH   SI
        PUSH   DI
        MOV   WORD PTR [BP-2], 0
; assign retval CalculCalciumcorrige
...
_PSPL_2:
        ...
        POP   BP
        RET   4
_PSPF_CALCULCALCIUMCORRIGE   ENDP
...
; write
        ...
        CALL   _PSPRT_PRINTSTR
; writeln
; call calculcalciumcorrige
        MOV   AX, 2
        PUSH   AX
        MOV   AX, 40
        PUSH   AX
        CALL   _PSPF_CALCULCALCIUMCORRIGE
...
_PSPK_HTML_1  DB  '<html>
  <head>
    <title>Pascal Server Pages - Calcul le calcium corrigé</title>
  </head>
  <body>
',0
_PSPK_3  DB  'Si Albumine=40g/L et Calcium Total=2,28mg/L alors le Calcium corrigé vaut ',0
_PSPK_4  DB  'mg/L',0
_PSPK_5  DB  '<br />',0
_PSPK_6  DB  'Si Albumine=38g/L et Calcium Total=2,28mg/L alors le Calcium corrigé vaut ',0
_PSPK_7  DB  'mg/L',0
_PSPK_8  DB  '<br />',0
_PSPK_HTML_9  DB  '
  </body>
