...
; Source : samples\PSP\test_function.psp
; ========================================
...
; assign Square
        ...
        POP   AX
        IMUL   BX
        MOV   WORD PTR [_PSPF_SQUARE], AX

; --- Add5 ---
_PSPF_ADD5   PROC NEAR
        PUSH   BP
        MOV   BP, SP
        SUB   SP, 2
        PUSH   SI
...
_PSP_A  DW  0
_PSP_B  DW  0
_PSPK_5  DB  'Square de ',0
_PSPK_6  DB  ' = ',0
_PSPK_7  DB  'Add5 de ',0
_PSPK_8  DB  ' = ',0
_PSPK_HTML_9  DB  '
  </body>
</html>
