...
; Source : samples\PSP\test_func.psp
; ========================================
...
; call double
        ...
        PUSH   AX
        CALL   _PSPF_DOUBLE
        MOV   WORD PTR [_PSP_R], AX
; write
        MOV   AX, WORD PTR [_PSP_R]
        CALL   _PSPRT_NUMTOSTR
        MOV   SI, OFFSET _PSPRT_NUMBUF
        CALL   _PSPRT_PRINTSTR
; writeln
