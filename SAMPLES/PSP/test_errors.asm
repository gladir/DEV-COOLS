...
; Source : SAMPLES/PSP/test_errors.psp
...
; try
        PUSH   DWORD PTR [_PSPX_HANDLER]
        PUSH   DWORD PTR [_PSPX_SAVESP]
        PUSH   DWORD PTR [_PSPX_SAVEBP]
        MOV   DWORD PTR [_PSPX_HANDLER], OFFSET _PSPL_2
        MOV   DWORD PTR [_PSPX_SAVESP], ESP
        MOV   DWORD PTR [_PSPX_SAVEBP], EBP
; assign a
        MOV   EAX, 10
        MOV   DWORD PTR [_PSP_A], EAX
; assign b
        MOV   EAX, 2
        MOV   DWORD PTR [_PSP_B], EAX
; assign a
        MOV   EAX, DWORD PTR [_PSP_A]
        PUSH   EAX
        MOV   EAX, DWORD PTR [_PSP_B]
        MOV   EBX, EAX
        POP   EAX
        CMP   EBX, 0
        JE   _PSPRT_PANIC_DIV0
        CDQ
        IDIV   EBX
        MOV   DWORD PTR [_PSP_A], EAX
; write
...
; write
        ...
        CALL   _PSPRT_PRINTSTR
_PSPL_3:
        POP   DWORD PTR [_PSPX_SAVEBP]
        POP   DWORD PTR [_PSPX_SAVESP]
        POP   DWORD PTR [_PSPX_HANDLER]
; writeln
...
; try
        ...
        PUSH   DWORD PTR [_PSPX_SAVESP]
        PUSH   DWORD PTR [_PSPX_SAVEBP]
        MOV   DWORD PTR [_PSPX_HANDLER], OFFSET _PSPL_6
        MOV   DWORD PTR [_PSPX_SAVESP], ESP
        MOV   DWORD PTR [_PSPX_SAVEBP], EBP
; assign a
        MOV   EAX, 42
...
; try
        ...
        PUSH   DWORD PTR [_PSPX_SAVESP]
        PUSH   DWORD PTR [_PSPX_SAVEBP]
        MOV   DWORD PTR [_PSPX_HANDLER], OFFSET _PSPL_11
        MOV   DWORD PTR [_PSPX_SAVESP], ESP
        MOV   DWORD PTR [_PSPX_SAVEBP], EBP
; try
        PUSH   DWORD PTR [_PSPX_HANDLER]
        PUSH   DWORD PTR [_PSPX_SAVESP]
        PUSH   DWORD PTR [_PSPX_SAVEBP]
        MOV   DWORD PTR [_PSPX_HANDLER], OFFSET _PSPL_13
        MOV   DWORD PTR [_PSPX_SAVESP], ESP
        MOV   DWORD PTR [_PSPX_SAVEBP], EBP
; assign a
        MOV   EAX, 100
...
_PSP_B  DD  0
_PSP_S  DD  0
_PSPK_1  DB  'Test try/except: ',0
_PSPK_4  DB  'Exception attrapee',0
_PSPK_5  DB  'Test try/finally: ',0
_PSPK_8  DB  'except',0
_PSPK_9  DB  ' finally',0
_PSPK_10  DB  'Test try imbrique: ',0
_PSPK_15  DB  'inner except',0
_PSPK_16  DB  'outer except',0
_PSPK_17  DB  'Div 10/3=',0
_PSPK_18  DB  'Mod 10%3=',0
_PSPK_19  DB  'Abs(-5)=',0
_PSPK_20  DB  'Done',0
_PSPK_HTML_21  DB  '
',0
