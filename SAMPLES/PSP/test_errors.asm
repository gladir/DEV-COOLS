...
; Source : samples\PSP\test_errors.psp
; ========================================
...
; try
        PUSH   WORD PTR [_PSPX_HANDLER]
        PUSH   WORD PTR [_PSPX_SAVESP]
        PUSH   WORD PTR [_PSPX_SAVEBP]
        MOV   WORD PTR [_PSPX_HANDLER], OFFSET _PSPL_2
        MOV   WORD PTR [_PSPX_SAVESP], SP
        MOV   WORD PTR [_PSPX_SAVEBP], BP
; assign a
        MOV   AX, 10
        MOV   WORD PTR [_PSP_A], AX
; assign b
        MOV   AX, 2
        MOV   WORD PTR [_PSP_B], AX
; assign a
        MOV   AX, WORD PTR [_PSP_A]
        PUSH   AX
        MOV   AX, WORD PTR [_PSP_B]
        MOV   BX, AX
        POP   AX
        CMP   BX, 0
...
_PSPL_3:
; finally
        POP   WORD PTR [_PSPX_SAVEBP]
        POP   WORD PTR [_PSPX_SAVESP]
        POP   WORD PTR [_PSPX_HANDLER]
_PSPL_4:
; writeln
...
; try
        ...
        PUSH   WORD PTR [_PSPX_SAVESP]
        PUSH   WORD PTR [_PSPX_SAVEBP]
        MOV   WORD PTR [_PSPX_HANDLER], OFFSET _PSPL_7
        MOV   WORD PTR [_PSPX_SAVESP], SP
        MOV   WORD PTR [_PSPX_SAVEBP], BP
; assign a
        MOV   AX, 42
...
; try
        ...
        PUSH   WORD PTR [_PSPX_SAVESP]
        PUSH   WORD PTR [_PSPX_SAVEBP]
        MOV   WORD PTR [_PSPX_HANDLER], OFFSET _PSPL_13
        MOV   WORD PTR [_PSPX_SAVESP], SP
        MOV   WORD PTR [_PSPX_SAVEBP], BP
; try
        PUSH   WORD PTR [_PSPX_HANDLER]
        PUSH   WORD PTR [_PSPX_SAVESP]
        PUSH   WORD PTR [_PSPX_SAVEBP]
        MOV   WORD PTR [_PSPX_HANDLER], OFFSET _PSPL_16
        MOV   WORD PTR [_PSPX_SAVESP], SP
        MOV   WORD PTR [_PSPX_SAVEBP], BP
; assign a
        MOV   AX, 100
...
_PSPK_5  DB  'Exception attrapee',0
_PSPK_6  DB  'Test try/finally: ',0
_PSPK_10  DB  'except',0
_PSPK_11  DB  ' finally',0
_PSPK_12  DB  'Test try imbrique: ',0
_PSPK_19  DB  'inner except',0
_PSPK_20  DB  'outer except',0
_PSPK_21  DB  'Div 10/3=',0
_PSPK_22  DB  'Mod 10%3=',0
_PSPK_23  DB  'Abs(-5)=',0
_PSPK_24  DB  'Done',0
_PSPK_HTML_25  DB  '
',0
