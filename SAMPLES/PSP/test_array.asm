...
; Source : SAMPLES/PSP/test_array.psp
...
; assign total
        XOR   EAX, EAX
        MOV   DWORD PTR [_PSP_TOTAL], EAX
; for
        MOV   EAX, 1
        MOV   DWORD PTR [_PSP_I], EAX
        MOV   EAX, 5
        MOV   DWORD PTR [_PSPL_1], EAX
_PSPL_2:
        MOV   EAX, DWORD PTR [_PSP_I]
        CMP   EAX, DWORD PTR [_PSPL_1]
        JG   _PSPL_3
; assign total
        MOV   EAX, DWORD PTR [_PSP_TOTAL]
        PUSH   EAX
        MOV   EAX, DWORD PTR [_PSP_I]
        SUB   EAX, 1
        SHL   EAX, 2
