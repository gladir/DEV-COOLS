...
; Source : samples\PSP\test_array.psp
; ========================================
...
; assign total
        XOR   AX, AX
        MOV   WORD PTR [_PSP_TOTAL], AX
; for
        MOV   AX, 1
        MOV   WORD PTR [_PSP_I], AX
        MOV   AX, 5
        MOV   WORD PTR [_PSPL_1], AX
_PSPL_2:
        MOV   AX, WORD PTR [_PSP_I]
        CMP   AX, WORD PTR [_PSPL_1]
        JG   _PSPL_3
; assign total
        MOV   AX, WORD PTR [_PSP_TOTAL]
        PUSH   AX
        MOV   AX, WORD PTR [_PSP_I]
        SUB   AX, 1
        SHL   AX, 1
