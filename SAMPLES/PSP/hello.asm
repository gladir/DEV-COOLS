...
; write
        ...
        CALL   _PSPRT_PRINTSTR
; html fragment
        MOV   ESI, OFFSET _PSPK_HTML_3
        CALL   _PSPRT_PRINTSTR
; for
        MOV   EAX, 1
        MOV   DWORD PTR [_PSP_I], EAX
        MOV   EAX, 10
        MOV   DWORD PTR [_PSPL_4], EAX
_PSPL_5:
        MOV   EAX, DWORD PTR [_PSP_I]
        CMP   EAX, DWORD PTR [_PSPL_4]
        JG   _PSPL_6
; writeln
        MOV   EAX, DWORD PTR [_PSP_I]
...
_PSPK_HTML_1  DB  '<html>
  <head>
    <title>C''est une  Pascal Server Pages</title>
  </head>
  <body>
    ',0
_PSPK_2  DB  'Bonjour',0
_PSPK_HTML_3  DB  '
    <p>Je vais utiliser Pascal Script pour écrire quelques nombres...</p>
    ',0
_PSP_I  DD  0
_PSPL_4  DD  0
_PSPK_HTML_8  DB  '
