...
; Source : samples\PSP\test_expr11.psp
; ========================================
...
; assign b
        XOR   AH, AH
        MOV   AL, BYTE PTR [_PSP_X]
        AND   AX, 00FFh
        MOV   BYTE PTR [_PSP_B], AL
; assign x
