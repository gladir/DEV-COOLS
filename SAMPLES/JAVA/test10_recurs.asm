...
START:
        ...
        CALL    _JF_test10_recurs_main  ; appel methode main
        CALL    _JRT_EXIT0              ; fin normale

; =========================================================
; Fichier genere par JAVAC86 v1.0
; Date    : 2026-03-02
; Source  : SAMPLES/JAVA/test10_recurs.java
; Classe  : 
...
; Classe : test10_recurs

; -----------------------------------------------------------------------
; Methode : fact
; -----------------------------------------------------------------------
_JF_test10_recurs_fact:
        PUSH BP
...
_JL_2:
        ...
        JZ      _JL_3
        MOV     AX, 1
        JMP     _JF_test10_recurs_fact_ret
_JL_3:
        MOV     AX, [BP+4]
        PUSH    AX
        MOV     AX, [BP+4]
        ...
        SUB     AX, BX
        PUSH    AX
        CALL    _JF_test10_recurs_fact
        ADD     SP, 2
        MOV     BX, AX                  ; operande droit
        POP     AX
        CALL    _JRT_IMUL
        JMP     _JF_test10_recurs_fact_ret
_JF_test10_recurs_fact_ret:
