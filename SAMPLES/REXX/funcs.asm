; REXX86 v1.0 - SAMPLES/REXX/funcs.rex
.MODEL SMALL
.STACK 1024
...
_RX_HEAPTOP DW 0
_RXK_1 DB '=== CALL simple ===',0
_RXV_RESULT DB 256 DUP(0)
_RXV_RESULT_D DB 'RESULT',0
_RXK_2 DB '=== Fonction avec RETURN ===',0
_RXV_X DB 256 DUP(0)
_RXV_X_D DB 'X',0
_RXK_3 DB '7',0
_RXK_4 DB 'doubler(7) =',0
_RXK_5 DB '=== PROCEDURE avec argument ===',0
_RXK_6 DB 'carre(5) =',0
_RXK_7 DB '5',0
_RXK_8 DB 'carre(12) =',0
_RXK_9 DB '12',0
_RXK_10 DB '=== PROCEDURE EXPOSE ===',0
_RXV_TOTAL DB 256 DUP(0)
_RXV_TOTAL_D DB 'TOTAL',0
_RXK_11 DB 'Total apres 3 appels :',0
_RXK_12 DB '=== CALL avec arguments ===',0
_RXK_13 DB 'additionner(3,4) =',0
_RXK_14 DB '3',0
_RXK_15 DB '4',0
_RXK_16 DB 'additionner(10,20) =',0
_RXK_17 DB '10',0
_RXK_18 DB '20',0
_RXK_19 DB '=== Recursion ===',0
_RXK_20 DB 'factorielle(5) =',0
_RXK_21 DB 'factorielle(1) =',0
_RXK_22 DB 'Fin du programme funcs.rex',0
_RXK_23 DB 'Bonjour depuis une procedure!',0
_RXV_N DB 256 DUP(0)
_RXV_N_D DB 'N',0
_DATA ENDS
