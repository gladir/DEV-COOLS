; REXX86 v1.0 - SAMPLES/REXX/stack.rex
.MODEL SMALL
.STACK 1024
...
_RX_HEAPTOP DW 0
_RXK_1 DB '=== QUEUE (FIFO) ===',0
_RXK_2 DB 'premier',0
_RXK_3 DB 'deuxieme',0
_RXK_4 DB 'troisieme',0
_RXK_5 DB 'Elements dans la pile :',0
_RXV_LIGNE DB 256 DUP(0)
_RXV_LIGNE_D DB 'LIGNE',0
_RXK_6 DB 'Pull 1 :',0
_RXK_7 DB 'Pull 2 :',0
_RXK_8 DB 'Pull 3 :',0
_RXK_9 DB 'Pile apres pulls :',0
_RXK_10 DB '=== PUSH (LIFO) ===',0
_RXK_11 DB 'A',0
_RXK_12 DB 'B',0
_RXK_13 DB 'C',0
_RXK_14 DB 'Elements :',0
_RXV_VAL DB 256 DUP(0)
_RXV_VAL_D DB 'VAL',0
_RXK_15 DB 'Pull (dernier PUSH) :',0
_RXK_16 DB 'Pull :',0
_RXK_17 DB '=== Melange QUEUE et PUSH ===',0
_RXK_18 DB 'file1',0
_RXK_19 DB 'file2',0
_RXK_20 DB 'pile1',0
...
_RXV_V3_D DB 'V3',0
_RXK_21 DB '=== Pile vide ===',0
_RXK_22 DB 'Pile vide :',0
_RXK_23 DB 'Fin du programme stack.rex',0
_DATA ENDS
