; REXX86 v1.0 - SAMPLES/REXX/parse.rex
.MODEL SMALL
.STACK 1024
...
_RX_HEAPTOP DW 0
_RXK_1 DB '=== PARSE VAR par mots ===',0
_RXV_LIGNE DB 256 DUP(0)
_RXV_LIGNE_D DB 'LIGNE',0
_RXK_2 DB 'rouge vert bleu jaune',0
_RXV_C1 DB 256 DUP(0)
_RXV_C1_D DB 'C1',0
_RXV_C2 DB 256 DUP(0)
_RXV_C2_D DB 'C2',0
_RXV_C3 DB 256 DUP(0)
_RXV_C3_D DB 'C3',0
_RXV_RESTE DB 256 DUP(0)
_RXV_RESTE_D DB 'RESTE',0
_RXK_3 DB 'Couleur 1 :',0
_RXK_4 DB 'Couleur 2 :',0
_RXK_5 DB 'Couleur 3 :',0
_RXK_6 DB 'Reste     :',0
_RXK_7 DB '=== PARSE VAR avec delimiteur ===',0
_RXV_CSV DB 256 DUP(0)
_RXV_CSV_D DB 'CSV',0
_RXK_8 DB 'Paris,Lyon,Marseille',0
_RXK_9 DB ',',0
_RXV_V1 DB 256 DUP(0)
_RXV_V1_D DB 'V1',0
_RXV_V2 DB 256 DUP(0)
_RXV_V2_D DB 'V2',0
_RXV_V3 DB 256 DUP(0)
_RXV_V3_D DB 'V3',0
_RXK_10 DB 'Ville 1 :',0
_RXK_11 DB 'Ville 2 :',0
_RXK_12 DB 'Ville 3 :',0
_RXK_13 DB '=== PARSE VAR avec position ===',0
_RXV_ENREG DB 256 DUP(0)
_RXV_ENREG_D DB 'ENREG',0
_RXK_14 DB 'NOM     PRENOM  AGE',0
_RXV_CHAMP1 DB 256 DUP(0)
_RXV_CHAMP1_D DB 'CHAMP1',0
_RXV_CHAMP2 DB 256 DUP(0)
_RXV_CHAMP2_D DB 'CHAMP2',0
_RXV_CHAMP3 DB 256 DUP(0)
_RXV_CHAMP3_D DB 'CHAMP3',0
_RXK_15 DB 'Champ 1 :',0
_RXK_16 DB 'Champ 2 :',0
_RXK_17 DB 'Champ 3 :',0
_RXK_18 DB '=== PARSE VAR avec placeholder ===',0
_RXV_INFO DB 256 DUP(0)
_RXV_INFO_D DB 'INFO',0
_RXK_19 DB 'ignorer garder ignorer2 garder2',0
_RXV_MOT1 DB 256 DUP(0)
_RXV_MOT1_D DB 'MOT1',0
_RXV_MOT2 DB 256 DUP(0)
_RXV_MOT2_D DB 'MOT2',0
_RXK_20 DB 'Mot 1 :',0
_RXK_21 DB 'Mot 2 :',0
_RXK_22 DB '=== PARSE UPPER VAR ===',0
_RXV_MIXTE DB 256 DUP(0)
_RXV_MIXTE_D DB 'MIXTE',0
_RXK_23 DB 'Hello World Rexx',0
_RXV_U1 DB 256 DUP(0)
_RXV_U1_D DB 'U1',0
_RXV_U2 DB 256 DUP(0)
_RXV_U2_D DB 'U2',0
_RXV_U3 DB 256 DUP(0)
_RXV_U3_D DB 'U3',0
_RXK_24 DB 'U1 :',0
_RXK_25 DB 'U2 :',0
_RXK_26 DB 'U3 :',0
_RXK_27 DB '=== PARSE VERSION ===',0
_RXK_28 DB 'REXX86 1.0',0
_RXV_VER DB 256 DUP(0)
_RXV_VER_D DB 'VER',0
_RXK_29 DB 'Version :',0
_RXK_30 DB '=== PARSE SOURCE ===',0
_RXK_31 DB 'DOS COMMAND REXX86',0
_RXV_SRC DB 256 DUP(0)
_RXV_SRC_D DB 'SRC',0
_RXK_32 DB 'Source :',0
_RXK_33 DB 'Fin du programme parse.rex',0
_DATA ENDS
