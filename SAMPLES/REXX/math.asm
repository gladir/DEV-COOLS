; REXX86 v1.0 - SAMPLES/REXX/math.rex
.MODEL SMALL
.STACK 1024
...
_RX_HEAPTOP DW 0
_RXK_1 DB '=== Operations arithmetiques ===',0
_RXK_2 DB '5 + 3   =',0
_RXK_3 DB '10 - 4  =',0
_RXK_4 DB '6 * 7   =',0
_RXK_5 DB '20 / 4  =',0
...
_RXK_7 DB '17 // 5 =',0
_RXK_8 DB '2 ** 10 =',0
_RXK_9 DB '=== Calculs avec variables ===',0
_RXV_A DB 256 DUP(0)
_RXV_A_D DB 'A',0
_RXV_B DB 256 DUP(0)
_RXV_B_D DB 'B',0
...
_RXK_16 DB 'a % b =',0
_RXK_17 DB 'a // b =',0
_RXK_18 DB '=== Fonctions arithmetiques ===',0
_RXK_19 DB 'ABS(-42) =',0
_RXK_20 DB 'ABS(17)  =',0
_RXK_21 DB 'SIGN(-9) =',0
_RXK_22 DB 'SIGN(0)  =',0
...
_RXK_26 DB 'TRUNC(99) =',0
_RXK_27 DB '=== NUMERIC DIGITS ===',0
_RXK_28 DB 'DIGITS() =',0
_RXK_29 DB 'Apres NUMERIC DIGITS 5 :',0
_RXK_30 DB 'Apres reset :',0
_RXK_31 DB '=== NUMERIC FORM ===',0
_RXK_32 DB 'FORM() =',0
_RXK_33 DB 'Apres ENGINEERING :',0
_RXK_34 DB 'Retour SCIENTIFIC :',0
_RXK_35 DB 'Fin du programme math.rex',0
_DATA ENDS
