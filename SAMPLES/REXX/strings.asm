; REXX86 v1.0 - SAMPLES/REXX/strings.rex
.MODEL SMALL
.STACK 1024
...
_RX_HEAPTOP DW 0
_RXK_1 DB '=== LENGTH ===',0
_RXK_2 DB 'LENGTH("Bonjour") =',0
_RXK_3 DB 'Bonjour',0
_RXK_4 DB 'LENGTH("") =',0
_RXK_5 DB 'LENGTH("REXX 86") =',0
_RXK_6 DB 'REXX 86',0
_RXK_7 DB '=== SUBSTR ===',0
_RXV_PHRASE DB 256 DUP(0)
_RXV_PHRASE_D DB 'PHRASE',0
_RXK_8 DB 'Hello World',0
_RXK_9 DB 'SUBSTR("Hello World", 7) =',0
_RXK_10 DB 'SUBSTR("Hello World", 1, 5) =',0
_RXK_11 DB '=== LEFT / RIGHT ===',0
_RXV_MOT DB 256 DUP(0)
_RXV_MOT_D DB 'MOT',0
_RXK_12 DB 'LEFT("Bonjour", 3) =',0
_RXK_13 DB 'RIGHT("Bonjour", 4) =',0
_RXK_14 DB '=== COPIES ===',0
_RXK_15 DB 'COPIES("*", 10) =',0
_RXK_16 DB '*',0
_RXK_17 DB 'COPIES("ab", 4) =',0
_RXK_18 DB 'ab',0
_RXK_19 DB '=== REVERSE ===',0
_RXK_20 DB 'REVERSE("Hello") =',0
_RXK_21 DB 'Hello',0
_RXK_22 DB 'REVERSE("12345") =',0
_RXK_23 DB '12345',0
_RXK_24 DB '=== POS / LASTPOS ===',0
_RXV_TEXTE DB 256 DUP(0)
_RXV_TEXTE_D DB 'TEXTE',0
_RXK_25 DB 'abracadabra',0
_RXK_26 DB 'POS("bra", "abracadabra") =',0
_RXK_27 DB 'bra',0
_RXK_28 DB 'LASTPOS("a", "abracadabra") =',0
_RXK_29 DB 'a',0
_RXK_30 DB '=== CENTER ===',0
_RXK_31 DB 'CENTER("OK", 10) =',0
_RXK_32 DB 'OK',0
_RXK_33 DB '=== STRIP ===',0
_RXK_34 DB 'STRIP("  espaces  ") =',0
_RXK_35 DB '  espaces  ',0
_RXK_36 DB '=== SPACE ===',0
_RXK_37 DB 'SPACE("un  deux  trois") =',0
_RXK_38 DB 'un  deux  trois',0
_RXK_39 DB '=== OVERLAY ===',0
_RXK_40 DB 'OVERLAY("XX", "abcdef", 3) =',0
_RXK_41 DB 'XX',0
_RXK_42 DB 'abcdef',0
_RXK_43 DB '=== INSERT ===',0
_RXK_44 DB 'INSERT("XX", "abcdef", 3) =',0
_RXK_45 DB '=== DELSTR ===',0
_RXK_46 DB 'DELSTR("abcdef", 3, 2) =',0
_RXK_47 DB 'Fin du programme strings.rex',0
_DATA ENDS
