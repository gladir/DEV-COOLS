; REXX86 v1.0 - SAMPLES/REXX/loops.rex
.MODEL SMALL
.STACK 1024
...
; DO expr (repeat N times)
        ...
        MOV     SI, AX
        CALL     _RXRT_STRTONUM
        MOV     WORD PTR _RXL_10_CNT, AX
_RXL_11:
        MOV     AX, WORD PTR _RXL_10_CNT
        CMP   AX, 0
        JLE     _RXL_12
; SAY
        LEA     AX, _RXK_6
...
_RX_HEAPTOP DW 0
_RXK_1 DB '=== DO compteur TO ===',0
_RXV_I DB 256 DUP(0)
_RXV_I_D DB 'I',0
_RXL_1_FIN DB 256 DUP(0)
_RXK_2 DB 'i =',0
_RXK_3 DB '=== DO compteur BY ===',0
_RXV_J DB 256 DUP(0)
_RXV_J_D DB 'J',0
_RXL_5_FIN DB 256 DUP(0)
_RXL_6_STEP DB 256 DUP(0)
_RXK_4 DB 'j =',0
_RXK_5 DB '=== DO N fois ===',0
_RXL_10_CNT DW 0
_RXK_6 DB 'Repetition',0
_RXK_7 DB '=== DO FOREVER + LEAVE ===',0
_RXV_K DB 256 DUP(0)
_RXV_K_D DB 'K',0
_RXK_8 DB 'k =',0
_RXK_9 DB 'Boucle terminee, k =',0
_RXK_10 DB '=== DO WHILE + ITERATE ===',0
_RXV_M DB 256 DUP(0)
_RXV_M_D DB 'M',0
_RXK_11 DB 'm =',0
_RXK_12 DB '=== DO bloc simple ===',0
_RXK_13 DB 'Ligne 1 du bloc',0
_RXK_14 DB 'Ligne 2 du bloc',0
_RXK_15 DB '=== Boucles imbriquees ===',0
_RXV_A DB 256 DUP(0)
_RXV_A_D DB 'A',0
_RXL_27_FIN DB 256 DUP(0)
_RXV_B DB 256 DUP(0)
_RXV_B_D DB 'B',0
_RXL_31_FIN DB 256 DUP(0)
_RXK_16 DB '*',0
_RXK_17 DB '=',0
_RXK_18 DB 'Fin du programme loops.rex',0
_DATA ENDS
