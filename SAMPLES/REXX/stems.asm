; REXX86 v1.0 - SAMPLES/REXX/stems.rex
.MODEL SMALL
.STACK 1024
...
_RXK_8 DB 'fruit.1 =',0
_RXK_9 DB 'fruit.2 =',0
_RXK_10 DB 'fruit.3 =',0
_RXK_11 DB '=== Valeur par defaut ===',0
_RXK_12 DB 'PRIX.',0
_RXK_13 DB 'prix.99 (defaut) =',0
_RXK_14 DB 'PRIX.99',0
_RXK_15 DB 'PRIX.1',0
_RXK_16 DB '10',0
_RXK_17 DB 'prix.1 =',0
_RXK_18 DB 'prix.2 (defaut) =',0
_RXK_19 DB 'PRIX.2',0
_RXK_20 DB '=== Indices dynamiques ===',0
_RXV_I DB 256 DUP(0)
_RXV_I_D DB 'I',0
_RXK_21 DB 'TAB.',0
_RXK_22 DB 'premier',0
_RXK_23 DB 'deuxieme',0
_RXK_24 DB 'troisieme',0
_RXK_25 DB 'tab.1 =',0
_RXK_26 DB 'TAB.1',0
_RXK_27 DB 'tab.2 =',0
_RXK_28 DB 'TAB.2',0
_RXK_29 DB 'tab.3 =',0
_RXK_30 DB 'TAB.3',0
_RXK_31 DB '=== Lecture dynamique ===',0
_RXV_J DB 256 DUP(0)
_RXV_J_D DB 'J',0
_RXK_32 DB 'tab.',0
_RXK_33 DB '=',0
_RXK_34 DB '=== Ecrasement ===',0
_RXK_35 DB 'POMME',0
_RXK_36 DB 'fruit.1 ecrase =',0
_RXK_37 DB '=== DROP ===',0
_RXK_38 DB 'FRUIT.',0
_RXK_39 DB 'fruit.1 apres DROP =',0
_RXK_40 DB 'Fin du programme stems.rex',0
_DATA ENDS
