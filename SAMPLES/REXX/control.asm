; REXX86 v1.0 - SAMPLES/REXX/control.rex
.MODEL SMALL
.STACK 1024
...
; assign: COMPTEUR = ...
        MOV     AX, 1
        MOV     SI, AX
        LEA     DI, _RXV_COMPTEUR
        CALL     _RXRT_STRCPY
; DO WHILE
_RXL_34:
        LEA     AX, _RXV_COMPTEUR
        PUSH     AX
        MOV     AX, 5
        MOV     BX, AX
        POP     AX
...
_RXV_X DB 256 DUP(0)
_RXV_X_D DB 'X',0
_RXK_2 DB 'x est superieur a 5',0
_RXK_3 DB 'x vaut exactement 10',0
_RXK_4 DB 'ceci ne sera pas affiche',0
_RXK_5 DB '=== IF / THEN / ELSE ===',0
_RXV_NOTE DB 256 DUP(0)
_RXV_NOTE_D DB 'NOTE',0
_RXK_6 DB 'Reussite (note:',0
_RXK_7 DB ')',0
_RXK_8 DB 'Echec (note:',0
_RXK_9 DB 'Reussite',0
_RXK_10 DB '=== IF avec bloc DO/END ===',0
_RXV_AGE DB 256 DUP(0)
_RXV_AGE_D DB 'AGE',0
_RXK_11 DB 'Vous etes majeur.',0
_RXK_12 DB 'Acces autorise.',0
_RXK_13 DB 'Vous etes mineur.',0
_RXK_14 DB 'Acces refuse.',0
_RXK_15 DB '=== SELECT / WHEN / OTHERWISE ===',0
_RXV_JOUR DB 256 DUP(0)
_RXV_JOUR_D DB 'JOUR',0
_RXK_16 DB 'Lundi',0
_RXK_17 DB 'Mardi',0
_RXK_18 DB 'Mercredi',0
_RXK_19 DB 'Jeudi',0
_RXK_20 DB 'Vendredi',0
_RXK_21 DB 'Samedi',0
_RXK_22 DB 'Dimanche',0
_RXK_23 DB 'Jour invalide',0
_RXK_24 DB '=== DO WHILE ===',0
_RXV_COMPTEUR DB 256 DUP(0)
_RXV_COMPTEUR_D DB 'COMPTEUR',0
_RXK_25 DB 'Compteur :',0
_RXK_26 DB '=== DO UNTIL ===',0
_RXV_N DB 256 DUP(0)
_RXV_N_D DB 'N',0
_RXK_27 DB 'N =',0
_RXV_VAL DB 256 DUP(0)
_RXV_VAL_D DB 'VAL',0
_RXK_28 DB 'Non nul',0
_RXK_29 DB 'NOP fonctionne correctement.',0
_RXK_30 DB 'Fin du programme control.rex',0
_DATA ENDS
