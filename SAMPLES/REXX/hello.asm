; REXX86 v1.0 - SAMPLES/REXX/hello.rex
.MODEL SMALL
.STACK 1024
...
_RX_HEAPTOP DW 0
_RXK_1 DB 'Bonjour, monde!',0
_RXK_2 DB 'Hello, World!',0
_RXV_NOM DB 256 DUP(0)
_RXV_NOM_D DB 'NOM',0
_RXK_3 DB 'REXX',0
_RXV_VERSION DB 256 DUP(0)
_RXV_VERSION_D DB 'VERSION',0
_RXK_4 DB '86',0
_RXK_5 DB 'Compilateur :',0
_RXV_PRENOM DB 256 DUP(0)
_RXV_PRENOM_D DB 'PRENOM',0
_RXK_6 DB 'Jean',0
_RXV_FAMILLE DB 256 DUP(0)
_RXV_FAMILLE_D DB 'FAMILLE',0
_RXK_7 DB 'Dupont',0
_RXK_8 DB 'Nom complet :',0
_RXK_9 DB 'Identifiant :',0
_RXK_10 DB '.',0
_RXV_MSG DB 256 DUP(0)
_RXV_MSG_D DB 'MSG',0
_RXK_11 DB 'C',39,'est un test',0
_RXV_ANNEE DB 256 DUP(0)
_RXV_ANNEE_D DB 'ANNEE',0
_RXK_12 DB 'Annee :',0
_RXV_A DB 256 DUP(0)
_RXV_A_D DB 'A',0
_RXK_13 DB 'un',0
...
_RXK_15 DB 'trois',0
_RXK_16 DB '-',0
_RXK_17 DB 'Fin du programme hello.rex',0
_DATA ENDS
