...
;  Date   : 2026-03-03
;  Source : SAMPLES\BCPL\fib.b
;  Section: SAMPLES\BCPL\fib
...
_BL_15:
        ...
        MOV  AX, [BP-10]
        PUSH AX
        CALL  _BP_SAMPLES_BCPL_fib_FIBIT
        ADD  SP, 2
        CALL  _BRT_WRITEN
        CALL  _BRT_NEWLINE
        MOV  AX, [BP-10]
...
_BK_1                   DB      28, '---------------------------', 10d
_BK_2                   DB      21, '  FIBONACCI RECURSIF', 10d
_BK_3                   DB      6, '  fib('
_BK_4                   DB      4, ') = '
_BK_5                   DB      21, '  FIBONACCI ITERATIF', 10d
_BK_6                   DB      8, '  fibit('
_BK_7                   DB      4, ') = '
_BK_8                   DB      37, '  Suite de Fibonacci jusqu', 39d, 'a 1000 :*N'
