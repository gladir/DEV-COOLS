...
; Genere automatiquement a partir de : SAMPLES/C/volatile_complete_test.c
...
_CCV_global_volatile  DD 0
_CCV_normal_var  DD 0
...
_CCF_main:
        ...
        MOV EBP,ESP
        SUB ESP,8
;   local local_volatile = [EBP-4]
;   local local_normal = [EBP-8]
        MOV EAX,5
        MOV DWORD PTR [_CCV_global_volatile],EAX
        MOV EAX,15
        MOV DWORD PTR [EBP-4],EAX
        MOV EAX,25
        MOV DWORD PTR [_CCV_normal_var],EAX
        MOV EAX,35
