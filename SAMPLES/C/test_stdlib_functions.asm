...
; Genere automatiquement a partir de : SAMPLES/C/test_stdlib_functions.c
...
_CCK_1  DB 'nul',0
_CCK_2  DB 'r',0
_CCK_3  DB 'Test stdlib functions',10,0
_CCK_4  DB 0
_CCK_5  DB '%d',0
_CCK_6  DB '42',0
_CCK_7  DB 'PATH',0
...
_CCK_10  DB 'abc',0
_CCV_g_result  DD 0
_CCV_g_buf  DB 256 DUP(0)
_CCV_g_buf2  DB 256 DUP(0)
_CCV_g_int  DD 0
_CCV_g_ptr  DD 0
...
; strlen (runtime)
        ...
        MOV DWORD PTR [EBP-8],EAX
        MOV EAX,DWORD PTR [EBP-8]
        MOV DWORD PTR [_CCV_g_result],EAX
        MOV EAX,0
        JMP _CCL_1
_CCL_1:
        MOV ESP,EBP
...
_CCK_11  DB 'Test stdlib functions',0
