...
; Genere automatiquement a partir de : SAMPLES/C/test_time_funcs.c
...
_CCK_1  DB '=== Test time.h ===',10,0
_CCK_2  DB 'time()=%d',10,0
_CCK_3  DB 'clock()=%d',10,0
_CCK_4  DB 'time.h: OK',10,0
...
; printf (TODO 21)
        ...
        CALL _CCRT_PRINTCRLF
        XOR EAX,EAX
; WARNING: variable non trouvee: time_t
        XOR EAX,EAX
; printf (TODO 21)
        MOV ESI,OFFSET _CCK_6
        CALL _CCRT_PRINTSTR
; WARNING: variable non trouvee: t
        XOR EAX,EAX
        CALL _CCRT_PRINTINT
        CALL _CCRT_PRINTCRLF
        XOR EAX,EAX
; WARNING: variable non trouvee: clock_t
        XOR EAX,EAX
; printf (TODO 21)
        MOV ESI,OFFSET _CCK_7
        CALL _CCRT_PRINTSTR
; WARNING: variable non trouvee: c
        XOR EAX,EAX
        CALL _CCRT_PRINTINT
        CALL _CCRT_PRINTCRLF
        XOR EAX,EAX
...
_CCK_5  DB '=== Test time.h ===',0
_CCK_6  DB 'time()=',0
_CCK_7  DB 'clock()=',0
_CCK_8  DB 'time.h: OK',0
