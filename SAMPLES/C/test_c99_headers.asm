...
; Genere automatiquement a partir de : SAMPLES/C/test_c99_headers.c
...
_CCL_11:
        ...
        MOV DWORD PTR [EBP-8],EAX
_CCL_8:
; WARNING: variable non trouvee: _STDINT_H
        XOR EAX,EAX
        TEST EAX,EAX
        JZ _CCL_12
        MOV EAX,DWORD PTR [EBP-8]
...
; WARNING: variable non trouvee: _COMPLEX_H
        ...
        MOV DWORD PTR [EBP-8],EAX
_CCL_30:
; WARNING: variable non trouvee: _FENV_H
        XOR EAX,EAX
        TEST EAX,EAX
        JZ _CCL_32
        MOV EAX,DWORD PTR [EBP-8]
...
_CCL_41:
        ...
        MOV DWORD PTR [EBP-8],EAX
_CCL_38:
; WARNING: variable non trouvee: _ISO646_H
        XOR EAX,EAX
        TEST EAX,EAX
        JZ _CCL_42
        MOV EAX,DWORD PTR [EBP-8]
...
; WARNING: variable non trouvee: _WCHAR_H
        ...
        MOV DWORD PTR [EBP-8],EAX
_CCL_44:
; WARNING: variable non trouvee: _WCTYPE_H
        XOR EAX,EAX
        TEST EAX,EAX
        JZ _CCL_46
        MOV EAX,DWORD PTR [EBP-8]
        ...
        MOV DWORD PTR [EBP-8],EAX
_CCL_46:
; WARNING: variable non trouvee: _TGMATH_H
        XOR EAX,EAX
        TEST EAX,EAX
        JZ _CCL_48
        MOV EAX,DWORD PTR [EBP-8]
        ...
        MOV DWORD PTR [EBP-8],EAX
_CCL_48:
; WARNING: variable non trouvee: _INTTYPES_H
        XOR EAX,EAX
        TEST EAX,EAX
        JZ _CCL_50
        MOV EAX,DWORD PTR [EBP-8]
