...
; Genere automatiquement a partir de : SAMPLES/C/test_math_funcs.c
...
_CCK_1  DB '=== Test math.h ===',10,0
_CCK_2  DB 'abs(-5)=%d',10,0
_CCK_3  DB 'math.h: OK',10,0
...
_CCK_4  DB '=== Test math.h ===',0
_CCK_5  DB 'abs(-5)=',0
_CCK_6  DB 'math.h: OK',0
