...
; Genere automatiquement a partir de : SAMPLES/C/test_memory_funcs.c
...
_CCK_1  DB '=== Test memory ops ===',10,0
_CCK_2  DB 'p1[0]=%d p1[3]=%d',10,0
_CCK_3  DB 'malloc/free: OK',10,0
_CCK_4  DB 'calloc[0]=%d',10,0
_CCK_5  DB 'calloc: OK',10,0
_CCK_6  DB 'realloc[0]=%d',10,0
_CCK_7  DB 'realloc: OK',10,0
_CCK_8  DB 'memory: OK',10,0
...
; realloc (runtime)
        ...
        MOV EAX,EDI
; cast vers pointeur (no-op)
; WARNING: variable non trouvee pour stockage: p4
; WARNING: variable non trouvee: p4
        XOR EAX,EAX
        TEST EAX,EAX
        JZ _CCL_8
; printf (TODO 21)
...
_CCK_9  DB '=== Test memory ops ===',0
_CCK_10  DB 'p1[0]=',0
_CCK_11  DB ' p1[3]=',0
_CCK_12  DB 'malloc/free: OK',0
_CCK_13  DB 'calloc[0]=',0
_CCK_14  DB 'calloc: OK',0
_CCK_15  DB 'realloc[0]=',0
_CCK_16  DB 'realloc: OK',0
_CCK_17  DB 'memory: OK',0
