...
; Genere automatiquement a partir de : SAMPLES/C/test_asm_mode.c
...
_CCK_1  DB 'square(7)=%d',10,0
_CCK_2  DB 'asm_mode: OK',10,0
...
_CCK_3  DB 'square(7)=',0
_CCK_4  DB 'asm_mode: OK',0
