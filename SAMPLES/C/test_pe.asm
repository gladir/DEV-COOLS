...
; Genere automatiquement a partir de : SAMPLES/C/test_pe.c
...
_CCK_1  DB 'PE test: Hello from CCW32!',10,0
_CCK_2  DB 'Sum of 1..10 = ',0
_CCK_3  DB '%d',10,0
_CCK_4  DB 'n is positive: %d',10,0
_CCK_5  DB 'n is not positive',10,0
...
_CCK_6  DB 'PE test: Hello from CCW32!',0
_CCK_7  DB 'n is positive: ',0
_CCK_8  DB 'n is not positive',0
