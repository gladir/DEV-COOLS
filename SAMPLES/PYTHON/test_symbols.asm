; Genere par PYTHON86 v1.0 - SAMPLES/PYTHON/test_symbols.py
...
; assign: total = expr
        MOV    AX, 100
        MOV    [_PYV_total], AX
; assign: my_variable = expr
        MOV    AX, 1
        MOV    [_PYV_my_variable], AX
; assign: another_var = expr
        MOV    AX, 2
        MOV    [_PYV_another_var], AX
; assign: combined = expr
; ident: my_variable [_PYV_my_variable]
; ident: another_var [_PYV_another_var]
        MOV    AX, [_PYV_my_variable]
        PUSH   AX
        MOV    AX, [_PYV_another_var]
        MOV    BX, AX
        POP    AX
        ADD    AX, BX
        MOV    [_PYV_combined], AX
; assign: a = expr
        MOV    AX, 1
        MOV    [_PYV_a], AX
; assign: b = expr
...
_PYV_v  DW  0
_PYV_total  DW  0
_PYV_my_variable  DW  0
_PYV_another_var  DW  0
_PYV_combined  DW  0
_PYV_a  DW  0
_PYV_b  DW  0
_PYV_c  DW  0
