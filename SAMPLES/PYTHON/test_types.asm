; Genere par PYTHON86 v1.0 - SAMPLES/PYTHON/test_types.py
...
; builtin call: type
        ...
        MOV    [_PYV_t], AX
; assign: check = expr
; ident: isinstance [_PYRT_isinstance]
; ident: x [_PYV_x]
        MOV    AX, [_PYV_x]
        PUSH   AX
; ident: int [_PYRT_int]
        ...
        PUSH   AX
        POP    AX
; builtin call: isinstance
        CALL   _PYRT_isinstance
        ADD    SP, 2
        MOV    [_PYV_check], AX
; assign: i = expr
; ident: int [_PYRT_int]
...
_PYV_a  DW  0
_PYV_c  DW  0
_PYK_3  DB  97,98,99,0
_PYK_4  DB  100,101,102,0
_PYV_d  DW  0
_PYV_t  DW  0
_PYV_check  DW  0
_PYV_i  DW  0
_PYK_5  DB  116,101,115,116,0
_PYV_s  DW  0
_PYV_bl  DW  0
