...
; cfdefaultcase
; cfoutput: texte brut
        MOV   SI, OFFSET _CFK_22
        CALL   _CFRT_PRINT
        JMP   _CFL_CSEND_15
_CFL_CSEND_15:
; ---- CFSET ----
        MOV   AX, OFFSET _CFK_23
        MOV   [_CFV_lang], AX
        MOV   AX, [_CFV_lang]
        PUSH   AX
        POP   AX
...
_CF_HEAPTOP  DW  0
_CFV_x  DW  0
_CFK_3  DB  'x est grand',0
_CFV_note  DW  0
_CFK_6  DB  'Excellent',0
_CFK_8  DB  'Bien',0
_CFK_10  DB  'Passable',0
_CFK_11  DB  'Echec',0
_CFV_age  DW  0
_CFV_permis  DW  0
_CFK_14  DB  'Majeur',0
...
_CFK_17  DB  'Lundi',0
_CFK_19  DB  'Mardi',0
_CFK_21  DB  'Mercredi',0
_CFK_22  DB  'Autre jour',0
_CFK_23  DB  'CF',0
_CFV_lang  DW  0
_CFK_26  DB  'ColdFusion',0
