...
; cftry: debut
        MOV   AX, [_CF_HANDLER]
        PUSH   AX
        MOV   WORD PTR [_CF_HANDLER], OFFSET _CFL_CATCH_7
; cfthrow: type=application message=Erreur de test
        MOV   WORD PTR [_CF_EXCTYPE], 1
        MOV   WORD PTR [_CF_EXCMSG], OFFSET _CFK_10
        MOV   WORD PTR [_CF_EXCDETAIL], OFFSET _CFK_11
        MOV   AX, [_CF_HANDLER]
        OR   AX, AX
        JZ   _CFRT_PANIC
        JMP   AX
...
; cftry: debut
        MOV   AX, [_CF_HANDLER]
        PUSH   AX
        MOV   WORD PTR [_CF_HANDLER], OFFSET _CFL_CATCH_14
; ---- CFSET ----
        MOV   AX, 10
        MOV   [_CFV_y], AX
; cftry: fin corps try, saut vers finally
...
; cftry: fin
; cfoutput: texte brut
        MOV   SI, OFFSET _CFK_19
        CALL   _CFRT_PRINT
; cftry: debut
        MOV   AX, [_CF_HANDLER]
        PUSH   AX
        MOV   WORD PTR [_CF_HANDLER], OFFSET _CFL_CATCH_20
; cftry: debut
        MOV   AX, [_CF_HANDLER]
        PUSH   AX
        MOV   WORD PTR [_CF_HANDLER], OFFSET _CFL_CATCH_23
; cfthrow: type=application message=erreur interne
        MOV   WORD PTR [_CF_EXCTYPE], 1
        MOV   WORD PTR [_CF_EXCMSG], OFFSET _CFK_26
...
; script try: debut
        MOV   AX, [_CF_HANDLER]
        PUSH   AX
        MOV   WORD PTR [_CF_HANDLER], OFFSET _CFL_SCATCH_29
; ---- VAR (local) ----
        MOV   AX, 99
        MOV   [_CFV_z], AX
...
_CFK_6  DB  'Erreur attrapee',0
_CFK_10  DB  'Erreur de test',0
_CFK_11  DB  'detail',0
_CFK_13  DB  'Catch application: ',0
_CFV_y  DW  0
_CFK_18  DB  'Erreur',0
_CFK_19  DB  'Finally execute',0
_CFK_26  DB  'erreur interne',0
_CFK_28  DB  'Exception relancee',0
_CFV_z  DW  0
_CFV_e_message  DW  0
_CFK_33  DB  'done',0
