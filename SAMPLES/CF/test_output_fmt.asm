...
; Source: /home/runner/work/DEV-COOLS/DEV-COOLS/SAMPLES/CF/test_output_fmt.cfm
...
; cfsilent: debut suppression sortie
; ---- CFSET ----
        MOV   AX, 42
        MOV   [_CFV_silentvar], AX
; cfsilent: fin suppression sortie
; cfsavecontent: debut redirection -> savedContent
        CALL   _CFRT_SCSTART
; cfoutput: texte brut
        MOV   SI, OFFSET _CFK_1
        CALL   _CFRT_SCAPPEND
; cfsavecontent: stocker buffer dans savedContent
        MOV   AX, OFFSET _CF_SCBUF
        MOV   [_CFV__CFV_savedcontent], AX
; cfsavecontent: fin
; ---- CFSET ----
; DateFormat() (stub: retourne valeur brute)
        MOV   AX, 20260101
        PUSH   AX
        ...
        MOV   [_CFV_d], AX
; ---- CFSET ----
; TimeFormat() (stub: retourne valeur brute)
        MOV   AX, 1200
        PUSH   AX
        ...
        MOV   [_CFV_t], AX
; ---- CFSET ----
; LSCurrencyFormat() (stub: retourne valeur brute)
        MOV   AX, 42
        PUSH   AX
        POP   AX
        CALL   _CFRT_NUMTOSTR
...
; cfcontent (stub)
; cflog (stub)
        MOV   AX, [_CFV_silentvar]
; cfoutput: expr numerique
        CALL   _CFRT_PRINTNUM
        MOV   AX, [_CFV_savedcontent]
...
_CFV__CFV_savedcontent  DW  0
_CFK_2  DB  'mm/dd/yyyy',0
_CFV_d  DW  0
_CFK_3  DB  'HH:mm',0
_CFV_t  DW  0
_CFV_c  DW  0
