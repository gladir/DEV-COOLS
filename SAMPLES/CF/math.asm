...
; function additionner returnType=numeric access=public
_CFF_additionner:
        PUSH   BP
        MOV   BP, SP
;   arg a @ [BP+6]
...
; function factorielle returnType=numeric access=public
_CFF_factorielle:
        PUSH   BP
        MOV   BP, SP
;   arg n @ [BP+4]
...
_CFK_10  DB  'Abs(-42) = ',0
_CFV_vmx  DW  0
_CFK_11  DB  'Max(15,27) = ',0
_CFV_vmn  DW  0
_CFK_12  DB  'Min(15,27) = ',0
_CFV_vi  DW  0
_CFK_13  DB  'IncrementValue(9) = ',0
_CFV_vd  DW  0
_CFK_14  DB  'DecrementValue(11) = ',0
_CFV_vs  DW  0
_CFK_15  DB  'Sgn(-3) = ',0
