...
; cfoutput: expr chaine
        MOV   SI, AX
        CALL   _CFRT_PRINT
; ---- cfinclude: include_helper.cfm ----
; ---- CFSET ----
        MOV   AX, OFFSET _CFK_2
        MOV   [_CFV_helper_msg], AX
; ---- fin cfinclude: include_helper.cfm ----
        MOV   AX, [_CFV_helper_msg]
; cfoutput: expr chaine
        MOV   SI, AX
        CALL   _CFRT_PRINT
; cfinvoke: Compteur.incrementer
        CALL   _CFC_Compteur_incrementer
        MOV   [_CFV_result], AX
; cfoutput: texte brut
...
_CFK_1  DB  'Bonjour',0
_CFV_greeting  DW  0
_CFK_2  DB  'inclus avec succes',0
_CFV_helper_msg  DW  0
_CFV_result  DW  0
_CFK_3  DB  'Resultat invoke: ',0
_CFK_4  DB  'Include OK',0
