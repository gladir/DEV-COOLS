...
; Source: SAMPLES/CF/component.cfc
...
; function incrementer returnType=numeric access=public
_CFF_incrementer:
        PUSH   BP
        MOV   BP, SP
        SUB   SP, 128
...
; function getValeur returnType=numeric access=public
_CFF_getValeur:
        PUSH   BP
        MOV   BP, SP
        SUB   SP, 128
...
; getter: getvaleur()
_CFC_Compteur_getvaleur:
        PUSH   BP
        MOV   BP, SP
        MOV   SI, [BP+4]
        MOV   DI, OFFSET _CFK_7
        CALL   _CFRT_STFIND
        MOV   SP, BP
        POP   BP
        RET
...
; setter: setvaleur(val)
_CFC_Compteur_setvaleur:
        PUSH   BP
        MOV   BP, SP
        MOV   SI, [BP+6]
        MOV   DI, OFFSET _CFK_7
...
_CFL_8:
; ==== fin cfcomponent Compteur ====
; ==== <cfcomponent> ====
; heritage depuis Compteur
; ---- <cffunction> ----
        JMP   _CFL_10
...
_CFL_13:
; ==== fin cfcomponent CompteurDouble ====
; ---- CFSET ----
; CreateObject()
...
_CFV_cpt  DW  0
_CFV_r1  DW  0
_CFK_15  DB  'Apres increment: ',0
_CFV_r2  DW  0
_CFK_16  DB  'Apres 2e increment: ',0
_CFV_v  DW  0
_CFK_17  DB  'Valeur courante: ',0
_CFK_18  DB  'Composant OK',0
