...
; cfoutput: expr numerique
        CALL   _CFRT_PRINTNUM
; ---- CFSET ----
        MOV   AX, OFFSET _CF_NULL_STR
        MOV   [_CFV_resultat], AX
; ---- CFSET ----
        MOV   AX, OFFSET _CFK_8
        MOV   [_CFV_resultat], AX
; cfoutput: texte brut
        MOV   SI, OFFSET _CFK_9
        CALL   _CFRT_PRINT
        MOV   AX, [_CFV_resultat]
; cfoutput: expr chaine
        MOV   SI, AX
        CALL   _CFRT_PRINT
...
_CFV_greeting  DW  0
_CFK_2  DB  'ColdFusion',0
_CFV_nom  DW  0
_CFV_version  DW  0
_CFK_3  DB  'Bienvenue dans ',0
_CFK_4  DB  ' ',0
_CFK_5  DB  'Bonjour',0
_CFK_6  DB  'le monde',0
_CFV_msg  DW  0
_CFV_a  DW  0
_CFV_b  DW  0
_CFV_somme  DW  0
