...
; Genere automatiquement a partir de : SAMPLES/PASCAL/test_proc_simple.pas
...
_TPK_1  DB 'Message from procedure',0
_TPK_2  DB 'Before procedure call',0
_TPK_3  DB 'After procedure call',0
