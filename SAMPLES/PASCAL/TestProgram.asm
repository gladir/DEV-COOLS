...
; Genere automatiquement a partir de : SAMPLES/PASCAL/TestProgram.pas
...
; Obtenir le tas du processus
        CALL GetProcessHeap
        MOV [HHEAP],EAX
        MOV EAX,DWORD PTR [_TPV_ADDNUMBERS]
...
; writeln
        ...
        CALL _TPRT_PRINTSTR
        MOV EAX,42
        MOV DWORD PTR [_TPV_GLOBALVALUE],EAX
; writeln
        LEA EAX,[_TPK_2]
        MOV ESI,EAX
        CALL _TPRT_PRINTSTR
        MOV EAX,DWORD PTR [_TPV_GLOBALVALUE]
        CALL _TPRT_NUMTOSTR
        LEA ESI,[NUMBUF]
        CALL _TPRT_PRINTSTR
        LEA ESI,[CRLF]
