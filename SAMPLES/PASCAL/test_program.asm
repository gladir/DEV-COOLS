...
; Genere automatiquement a partir de : SAMPLES/PASCAL/test_program.pas
...
_TPK_1  DB 'Programme de test complet',0
...
; writeln
        ...
        CALL _TPRT_PRINTSTR
        MOV EAX,42
        MOV DWORD PTR [_TPV_COUNT],EAX
; writeln
        LEA EAX,[_TPK_4]
        MOV ESI,EAX
        CALL _TPRT_PRINTSTR
        MOV EAX,DWORD PTR [_TPV_COUNT]
        CALL _TPRT_NUMTOSTR
        LEA ESI,[NUMBUF]
        CALL _TPRT_PRINTSTR
        LEA ESI,[CRLF]
