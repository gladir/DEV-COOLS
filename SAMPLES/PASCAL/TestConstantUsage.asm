...
; Genere automatiquement a partir de : SAMPLES/PASCAL/TestConstantUsage.pas
...
; Obtenir le tas du processus
        ...
        MOV [HHEAP],EAX
        MOV EAX,100
        MOV DWORD PTR [_TPV_SIZE],EAX
        MOV EAX,1
        MOV BYTE PTR [_TPV_ISENABLED],AL
; write
        MOV EAX,DWORD PTR [_TPV_SIZE]
        CALL _TPRT_NUMTOSTR
        LEA ESI,[NUMBUF]
        CALL _TPRT_PRINTSTR
; write
        MOVZX EAX,BYTE PTR [_TPV_ISENABLED]
        TEST EAX,EAX
        JZ _TPL_2
        LEA ESI,[TRUE_STR]
        JMP _TPL_3
