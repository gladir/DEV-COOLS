...
; Genere automatiquement a partir de : SAMPLES/PASCAL/test_case_complete.pas
...
_TPK_1  DB 'Choix:',0
_TPK_2  DB 'Premier cas',0
_TPK_3  DB 'Action 1',0
_TPK_4  DB 'Deuxi',195,168,'me cas',0
