...
; Genere automatiquement a partir de : SAMPLES/PASCAL/test_convert.pas
...
_TPK_1  DB 'DEBUG: Input string: [',0
_TPK_2  DB '] Length=',0
_TPK_3  DB 'ldd  # ',0
_TPK_4  DB 'bipush ',0
_TPK_5  DB 'DEBUG: Matched ldd  # pattern',0
_TPK_6  DB 'ldd  #',0
_TPK_7  DB 'DEBUG: Matched ldd  # pattern (no space after #)',0
_TPK_8  DB 'std   ',0
_TPK_9  DB 'istore ',0
_TPK_10  DB 'DEBUG: Matched std with 3 spaces',0
_TPK_11  DB 'ldd   ',0
_TPK_12  DB 'iload ',0
_TPK_13  DB 'DEBUG: Matched ldd with 3 spaces',0
_TPK_14  DB 'DEBUG: No pattern matched',0
_TPK_15  DB 'DEBUG: Output string: [',0
_TPK_16  DB ']',0
_TPK_17  DB 'ldd  # 5',0
_TPK_18  DB 'std   x',0
_TPK_19  DB 'ldd   x',0
