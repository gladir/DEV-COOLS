...
; Genere automatiquement a partir de : SAMPLES/PASCAL/testop.pas
...
_TPK_1  DB '=== Test des op',195,169,'rateurs de comparaison ===',0
_TPK_2  DB 'a = b : VRAI',0
_TPK_3  DB 'a = b : FAUX',0
_TPK_4  DB 'a <> 5 : VRAI',0
_TPK_5  DB 'a <> 5 : FAUX',0
_TPK_6  DB 'a < 15 : VRAI',0
_TPK_7  DB 'a < 15 : FAUX',0
_TPK_8  DB 'a >= 10 : VRAI',0
_TPK_9  DB 'a >= 10 : FAUX',0
