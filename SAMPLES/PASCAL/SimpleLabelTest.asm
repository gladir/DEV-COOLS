...
; Affichage chaîne: Before label
.DATA
STR1 DB 'Before label$'
    mov dx, OFFSET STR1
    mov ah, 09h
    int 21h
    mov dl, 13
...
; DEBUG: Token = [MYLABEL]
; DEBUG: Token suivant = [:]
; Étiquette définie: MYLABEL
MYLABEL_LABEL:
; Affichage chaîne: At label
STR2 DB 'At label$'
    mov dx, OFFSET STR2
    mov ah, 09h
    int 21h
