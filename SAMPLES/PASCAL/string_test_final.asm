...
; Affichage chaîne: Test du support des chaînes
.DATA
STR0 DB 'Test du support des chaînes$'
    mov dx, OFFSET STR0
    mov ah, 09h
    int 21h
    mov dl, 13
    ...
    mov ah, 02h
    int 21h
; Affichage chaîne: Chaîne littérale: Hello Pascal
STR1 DB 'Chaîne littérale: Hello Pascal$'
    mov dx, OFFSET STR1
    mov ah, 09h
    int 21h
    mov dl, 13
...
; Comparer les longueurs
    ...
    mov bl, [di]
    cmp al, bl
    jne COMP_DIFF    ; Longueurs différentes

; Comparer les caractères
    mov cl, al       ; Nombre de caractères
    mov ch, 0
    inc si           ; Pointer après longueur
    inc di
    repe cmpsb       ; Comparer caractères
    je COMP_EQUAL
