...
; Genere automatiquement a partir de : SAMPLES/PASCAL/compare_loops.pas
...
_TPK_1  DB '=== Test WHILE ===',0
_TPK_2  DB 'Ceci ne devrait pas s afficher',0
_TPK_3  DB 'WHILE termine, i = 10',0
