; SAS86 v1.0 - SAMPLES/SAS/merge.sas
.MODEL SMALL
.STACK 1024
...
_SASL_11:
_SASL_10:
; OUTPUT : copier PDV -> dataset CHECK
        INC WORD PTR [_SAS_N]
        MOV WORD PTR [_SAS_ERROR], 0
        INC WORD PTR [_SAS_N]
; Boucle implicite : iteration suivante
...
; Reinitialiser PDV (variables non-RETAIN -> manquant)
        ...
        MOV WORD PTR [_SAS_PDV + 0], -32768
; MERGE (TODO 23)
; MERGE source=CLIENTS
; MERGE source=COMMANDES
...
_SASL_16:
; OUTPUT : copier PDV -> dataset FUSIONNE
        INC WORD PTR [_SAS_N]
        MOV WORD PTR [_SAS_ERROR], 0
        INC WORD PTR [_SAS_N]
_SASL_15:
; ========= FIN DATA STEP FUSIONNE =========
...
; charger LAST.REGION
        ...
        JZ _SASL_24
; OUTPUT explicite
; OUTPUT : copier PDV -> dataset GROUPES
        INC WORD PTR [_SAS_N]
        MOV WORD PTR [_SAS_ERROR], 0
_SASL_24:
        INC WORD PTR [_SAS_N]
...
; SET concatenation: 3 datasets
        MOV WORD PTR [_SAS_SETIDX], 0
_SASL_32:
; OUTPUT : copier PDV -> dataset ANNEE
        INC WORD PTR [_SAS_N]
        MOV WORD PTR [_SAS_ERROR], 0
        INC WORD PTR [_SAS_N]
; Boucle implicite : iteration suivante
...
_SAS_SETNOBS  DW  0
_SAS_SETPT  DW  0
_SASK_4  DB  'client copie',0
_SASK_13  DB  'Fin du dataset',0
