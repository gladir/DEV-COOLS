; SAS86 v1.0 - SAMPLES/SAS/test_runtime.sas
.MODEL SMALL
.STACK 1024
...
; PUT newline
        ...
        LEA DX, _SAS_CRLF
        INT 21h
        MOV AX, OFFSET _SASK_9
; stocker X
        MOV [_SAS_PDV + 8], AX
        MOV AX, OFFSET _SASK_10
; stocker Y
        MOV [_SAS_PDV + 10], AX
; charger X
        MOV AX, [_SAS_PDV + 8]
...
_SAS_SETNOBS  DW  0
_SAS_SETPT  DW  0
_SASK_6  DB  'Puissance : ',0
_SASK_8  DB  'ABS(-42) = ',0
_SASK_9  DB  'HELLO',0
_SASK_10  DB  'WORLD',0
_SASK_11  DB  'Concat : ',0
_SASK_12  DB  'HELLO',0
_SASK_19  DB  'String compare OK',0
_SASK_20  DB  'Runtime OK',0
