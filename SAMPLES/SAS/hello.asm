; SAS86 v1.0 - SAMPLES/SAS/hello.sas
.MODEL SMALL
.STACK 1024
...
_SAS_SETPT  DW  0
_SASK_4  DB  'SAS86',0
_SASK_5  DB  'Bonjour le monde!',0
_SASK_6  DB  'Compilateur:',0
_SASK_7  DB  'La reponse est',0
_SASK_13  DB  'a=',0
_SASK_14  DB  ' b=',0
_SASK_15  DB  ' somme=',0
