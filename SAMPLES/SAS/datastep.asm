; SAS86 v1.0 - SAMPLES/SAS/datastep.sas
.MODEL SMALL
.STACK 1024
...
; PUT newline
        ...
        INT 21h
; OUTPUT explicite
; OUTPUT : copier PDV -> dataset EMPLOYES
        INC WORD PTR [_SAS_N]
        MOV WORD PTR [_SAS_ERROR], 0
        INC WORD PTR [_SAS_N]
_SASL_2:
; ========= FIN DATA STEP EMPLOYES =========
...
; stocker X
        MOV [_SAS_PDV + 8], AX
; OUTPUT explicite
; OUTPUT : copier PDV -> dataset MULTI
        INC WORD PTR [_SAS_N]
        MOV WORD PTR [_SAS_ERROR], 0
        MOV AX, 2
; stocker X
...
; PUT newline
        ...
        INT 21h
_SASL_14:
; OUTPUT : copier PDV -> dataset FILTRE
        INC WORD PTR [_SAS_N]
        MOV WORD PTR [_SAS_ERROR], 0
        INC WORD PTR [_SAS_N]
_SASL_13:
; ========= FIN DATA STEP FILTRE =========
...
_SASL_26:
_SASL_24:
; OUTPUT : copier PDV -> dataset LIMITE
        INC WORD PTR [_SAS_N]
        MOV WORD PTR [_SAS_ERROR], 0
        INC WORD PTR [_SAS_N]
_SASL_23:
; ========= FIN DATA STEP LIMITE =========
