; SAS86 v1.0 - SAMPLES/SAS/procmeans.sas
.MODEL SMALL
.STACK 1024
...
_SAS_SETNOBS  DW  0
_SAS_SETPT  DW  0
_SASK_4  DB  'Variable N Mean Std Min Max',0
_SASK_5  DB  'NOTE',0
_SASK_7  DB  'HEURES',0
_SASK_9  DB  'Variable N Min Max Sum',0
_SASK_10  DB  'NOTE',0
_SASK_12  DB  'HEURES',0
_SASK_14  DB  'Statistiques des notes',0
_SASK_15  DB  'Variable N Mean Std Min Max',0
_SASK_16  DB  'NOTE',0
_SASK_18  DB  'NOTE Frequency Percent',0
