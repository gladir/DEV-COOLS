; Genere par PROLOG86 v1.0 - SAMPLES/PROLOG/test_facts.pl
; Date: 2026-03-06
...
; === Predicat animal/1 (3 clause(s)) ===
_PLP_animal_1:
; Backtracking WAM - 3 clauses

; try_me_else _PLP_animal_1_cp1
        MOV   BX, OFFSET _PLP_animal_1_cp1
        CALL    _PLRT_TRY
        CALL   _PLP_animal_1_0
        JNC   _PLP_animal_1_ok
_PLP_animal_1_cp1:
; retry_me_else _PLP_animal_1_cp2
        MOV   BX, OFFSET _PLP_animal_1_cp2
        CALL    _PLRT_RETRY
        CALL   _PLP_animal_1_1
        JNC   _PLP_animal_1_ok
_PLP_animal_1_cp2:
; trust_me
        CALL    _PLRT_TRUST
        CALL   _PLP_animal_1_2
        RET
_PLP_animal_1_ok:
...
; === Predicat age/2 (2 clause(s)) ===
_PLP_age_2:
; Backtracking WAM - 2 clauses

; try_me_else _PLP_age_2_cp1
        MOV   BX, OFFSET _PLP_age_2_cp1
        CALL    _PLRT_TRY
        CALL   _PLP_age_2_0
        JNC   _PLP_age_2_ok
_PLP_age_2_cp1:
...
; === Predicat color/2 (2 clause(s)) ===
_PLP_color_2:
; Backtracking WAM - 2 clauses

; try_me_else _PLP_color_2_cp1
        MOV   BX, OFFSET _PLP_color_2_cp1
        CALL    _PLRT_TRY
        CALL   _PLP_color_2_0
        JNC   _PLP_color_2_ok
_PLP_color_2_cp1:
