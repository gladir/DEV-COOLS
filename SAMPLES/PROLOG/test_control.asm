; Genere par PROLOG86 v1.0 - SAMPLES/PROLOG/test_control.pl
; Date: 2026-03-06
...
; --- Regle always_true/0 clause 0 (1 but(s), 0 var(s)) ---
_PLP_always_true_0_0:
        PUSH   BP
        MOV   BP, SP
; --- corps de la regle ---
...
; --- Regle not_animal/1 clause 0 (1 but(s), 1 var(s)) ---
_PLP_not_animal_1_0:
        PUSH   BP
        MOV   BP, SP
...
; === Predicat always_true/0 (1 clause(s)) ===

; === Predicat animal/1 (2 clause(s)) ===
_PLP_animal_1:
; Backtracking WAM - 2 clauses
...
; === Predicat plant/1 (1 clause(s)) ===
_PLP_plant_1:
        JMP   _PLP_plant_1_0

; === Predicat not_animal/1 (1 clause(s)) ===
_PLP_not_animal_1:
        JMP   _PLP_not_animal_1_0
