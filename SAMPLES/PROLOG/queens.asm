; Genere par PROLOG86 v1.0 - SAMPLES/PROLOG/queens.pl
; Date: 2026-03-06
...
; --- Regle perm/2 clause 1 (2 but(s), 4 var(s)) ---
_PLP_perm_2_1:
        PUSH   BP
        MOV   BP, SP
...
; --- Regle safe/1 clause 1 (2 but(s), 2 var(s)) ---
_PLP_safe_1_1:
        PUSH   BP
        MOV   BP, SP
...
; var Qs
        MOV   AX, WORD PTR [BP-4]
        MOV   WORD PTR [_PL_ARGS + 2], AX
        MOV   WORD PTR [_PL_ARGS + 4], 16385
; int 1
        CALL   _PLP_no_attack_3
        JC   _PLP_safe_1_1_F
...
_PLP_no_attack_3_0_F:
        STC
        MOV   SP, BP
        POP   BP
        RET

; --- Regle no_attack/3 clause 1 (6 but(s), 6 var(s)) ---
_PLP_no_attack_3_1:
        PUSH   BP
        MOV   BP, SP
...
; last call optimization
        MOV   SP, BP
        POP   BP
        JMP   _PLP_no_attack_3

_PLP_no_attack_3_1_F:
        STC
        MOV   SP, BP
        POP   BP
        RET

; --- Regle queens/1 clause 0 (2 but(s), 1 var(s)) ---
_PLP_queens_1_0:
        PUSH   BP
        MOV   BP, SP
...
; --- Regle main/0 clause 0 (3 but(s), 1 var(s)) ---
_PLP_main_0_0:
        PUSH   BP
        MOV   BP, SP
; allocate 1 variable(s) locale(s)
...
; === Predicat perm/2 (2 clause(s)) ===
_PLP_perm_2:
; Backtracking WAM - 2 clauses

; try_me_else _PLP_perm_2_cp1
        MOV   BX, OFFSET _PLP_perm_2_cp1
        CALL    _PLRT_TRY
        CALL   _PLP_perm_2_0
        JNC   _PLP_perm_2_ok
_PLP_perm_2_cp1:
...
; === Predicat safe/1 (2 clause(s)) ===
_PLP_safe_1:
; Backtracking WAM - 2 clauses

; try_me_else _PLP_safe_1_cp1
        MOV   BX, OFFSET _PLP_safe_1_cp1
        CALL    _PLRT_TRY
        CALL   _PLP_safe_1_0
        JNC   _PLP_safe_1_ok
_PLP_safe_1_cp1:
...
; === Predicat no_attack/3 (2 clause(s)) ===
_PLP_no_attack_3:
; Backtracking WAM - 2 clauses

; try_me_else _PLP_no_attack_3_cp1
        MOV   BX, OFFSET _PLP_no_attack_3_cp1
        CALL    _PLRT_TRY
        CALL   _PLP_no_attack_3_0
        JNC   _PLP_no_attack_3_ok
_PLP_no_attack_3_cp1:
; trust_me
        CALL    _PLRT_TRUST
        CALL   _PLP_no_attack_3_1
        RET
_PLP_no_attack_3_ok:
; Succes : retirer le choice point (commit)
        PUSH   SI
