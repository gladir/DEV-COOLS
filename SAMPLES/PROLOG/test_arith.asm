; Genere par PROLOG86 v1.0 - SAMPLES/PROLOG/test_arith.pl
; Date: 2026-03-06
...
; --- Regle greeting/0 clause 0 (1 but(s), 0 var(s)) ---
_PLP_greeting_0_0:
        PUSH   BP
        MOV   BP, SP
; --- corps de la regle ---
...
; --- Regle test_simple/1 clause 0 (1 but(s), 1 var(s)) ---
_PLP_test_simple_1_0:
        PUSH   BP
        MOV   BP, SP
...
_PLP_test_simple_1_0_F:
        STC
        MOV   SP, BP
        POP   BP
        RET

; --- Regle test_add/1 clause 0 (1 but(s), 1 var(s)) ---
_PLP_test_add_1_0:
        PUSH   BP
        MOV   BP, SP
; allocate 1 variable(s) locale(s)
...
; --- Regle test_sub/1 clause 0 (1 but(s), 1 var(s)) ---
_PLP_test_sub_1_0:
        PUSH   BP
        MOV   BP, SP
; allocate 1 variable(s) locale(s)
...
; --- Regle test_mul/1 clause 0 (1 but(s), 1 var(s)) ---
_PLP_test_mul_1_0:
        PUSH   BP
        MOV   BP, SP
; allocate 1 variable(s) locale(s)
...
; --- Regle test_div/1 clause 0 (1 but(s), 1 var(s)) ---
_PLP_test_div_1_0:
        PUSH   BP
        MOV   BP, SP
; allocate 1 variable(s) locale(s)
...
; --- Regle test_mod/1 clause 0 (1 but(s), 1 var(s)) ---
_PLP_test_mod_1_0:
        PUSH   BP
        MOV   BP, SP
; allocate 1 variable(s) locale(s)
...
; --- Regle test_complex/1 clause 0 (1 but(s), 1 var(s)) ---
_PLP_test_complex_1_0:
        PUSH   BP
        MOV   BP, SP
; allocate 1 variable(s) locale(s)
        SUB   SP, 2
...
_PLP_test_complex_1_0_F:
        STC
        MOV   SP, BP
        POP   BP
        RET

; --- Regle test_paren/1 clause 0 (1 but(s), 1 var(s)) ---
_PLP_test_paren_1_0:
        PUSH   BP
        MOV   BP, SP
; allocate 1 variable(s) locale(s)
...
_PLP_test_paren_1_0_F:
        STC
        MOV   SP, BP
        POP   BP
        RET

; --- Regle test_neg/1 clause 0 (1 but(s), 1 var(s)) ---
_PLP_test_neg_1_0:
        PUSH   BP
        MOV   BP, SP
; allocate 1 variable(s) locale(s)
...
; --- Regle test_var/2 clause 0 (1 but(s), 2 var(s)) ---
_PLP_test_var_2_0:
        PUSH   BP
        MOV   BP, SP
...
; --- Regle test_abs/1 clause 0 (1 but(s), 1 var(s)) ---
_PLP_test_abs_1_0:
        PUSH   BP
        MOV   BP, SP
; allocate 1 variable(s) locale(s)
...
; --- Regle test_succ/1 clause 0 (1 but(s), 1 var(s)) ---
_PLP_test_succ_1_0:
        PUSH   BP
        MOV   BP, SP
; allocate 1 variable(s) locale(s)
...
_PLP_test_succ_1_0_F:
        STC
        MOV   SP, BP
        POP   BP
        RET

; --- Regle test_max/1 clause 0 (1 but(s), 1 var(s)) ---
_PLP_test_max_1_0:
        PUSH   BP
        MOV   BP, SP
; allocate 1 variable(s) locale(s)
...
; --- Regle test_min/1 clause 0 (1 but(s), 1 var(s)) ---
_PLP_test_min_1_0:
        PUSH   BP
        MOV   BP, SP
; allocate 1 variable(s) locale(s)
...
; --- Regle test_gt/1 clause 0 (1 but(s), 1 var(s)) ---
_PLP_test_gt_1_0:
        PUSH   BP
        MOV   BP, SP
; allocate 1 variable(s) locale(s)
...
; --- Regle test_lt/1 clause 0 (1 but(s), 1 var(s)) ---
_PLP_test_lt_1_0:
        PUSH   BP
        MOV   BP, SP
; allocate 1 variable(s) locale(s)
...
; --- Regle test_eq/0 clause 0 (1 but(s), 0 var(s)) ---
_PLP_test_eq_0_0:
        PUSH   BP
        MOV   BP, SP
; --- corps de la regle ---
...
; --- Regle test_neq/0 clause 0 (1 but(s), 0 var(s)) ---
_PLP_test_neq_0_0:
        PUSH   BP
        MOV   BP, SP
; --- corps de la regle ---
...
; --- Regle test_leq/0 clause 0 (1 but(s), 0 var(s)) ---
_PLP_test_leq_0_0:
        PUSH   BP
        MOV   BP, SP
; --- corps de la regle ---
...
; --- Regle test_geq/0 clause 0 (1 but(s), 0 var(s)) ---
_PLP_test_geq_0_0:
        PUSH   BP
        MOV   BP, SP
; --- corps de la regle ---
...
; === Predicat greeting/0 (1 clause(s)) ===

; === Predicat test_simple/1 (1 clause(s)) ===
_PLP_test_simple_1:
        JMP   _PLP_test_simple_1_0

; === Predicat test_add/1 (1 clause(s)) ===
_PLP_test_add_1:
        JMP   _PLP_test_add_1_0

; === Predicat test_sub/1 (1 clause(s)) ===
_PLP_test_sub_1:
        JMP   _PLP_test_sub_1_0

; === Predicat test_mul/1 (1 clause(s)) ===
_PLP_test_mul_1:
        JMP   _PLP_test_mul_1_0

; === Predicat test_div/1 (1 clause(s)) ===
_PLP_test_div_1:
        JMP   _PLP_test_div_1_0

; === Predicat test_mod/1 (1 clause(s)) ===
_PLP_test_mod_1:
        JMP   _PLP_test_mod_1_0

; === Predicat test_complex/1 (1 clause(s)) ===
_PLP_test_complex_1:
        JMP   _PLP_test_complex_1_0

; === Predicat test_paren/1 (1 clause(s)) ===
_PLP_test_paren_1:
        JMP   _PLP_test_paren_1_0

; === Predicat test_neg/1 (1 clause(s)) ===
_PLP_test_neg_1:
        JMP   _PLP_test_neg_1_0

; === Predicat test_var/2 (1 clause(s)) ===
_PLP_test_var_2:
        JMP   _PLP_test_var_2_0

; === Predicat test_abs/1 (1 clause(s)) ===
_PLP_test_abs_1:
        JMP   _PLP_test_abs_1_0

; === Predicat test_succ/1 (1 clause(s)) ===
_PLP_test_succ_1:
        JMP   _PLP_test_succ_1_0

; === Predicat test_max/1 (1 clause(s)) ===
_PLP_test_max_1:
        JMP   _PLP_test_max_1_0

; === Predicat test_min/1 (1 clause(s)) ===
_PLP_test_min_1:
        JMP   _PLP_test_min_1_0

; === Predicat test_gt/1 (1 clause(s)) ===
_PLP_test_gt_1:
        JMP   _PLP_test_gt_1_0

; === Predicat test_lt/1 (1 clause(s)) ===
_PLP_test_lt_1:
        JMP   _PLP_test_lt_1_0

; === Predicat test_eq/0 (1 clause(s)) ===

; === Predicat test_neq/0 (1 clause(s)) ===

; === Predicat test_leq/0 (1 clause(s)) ===

; === Predicat test_geq/0 (1 clause(s)) ===
