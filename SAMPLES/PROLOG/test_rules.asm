; Genere par PROLOG86 v1.0 - SAMPLES/PROLOG/test_rules.pl
; Date: 2026-03-06
...
; --- Regle man/1 clause 0 (1 but(s), 1 var(s)) ---
_PLP_man_1_0:
        PUSH   BP
        MOV   BP, SP
...
; --- Regle woman/1 clause 0 (1 but(s), 1 var(s)) ---
_PLP_woman_1_0:
        PUSH   BP
        MOV   BP, SP
; allocate 1 variable(s) locale(s)
...
; --- Regle hello/0 clause 0 (1 but(s), 0 var(s)) ---
_PLP_hello_0_0:
        PUSH   BP
        MOV   BP, SP
; --- corps de la regle ---
...
; --- Fait world/0 clause 0 ---
_PLP_world_0:
        CLC
        RET

; --- Regle likes/2 clause 0 (1 but(s), 1 var(s)) ---
_PLP_likes_2_0:
        PUSH   BP
        MOV   BP, SP
; allocate 1 variable(s) locale(s)
...
; --- Regle age_ok/1 clause 0 (1 but(s), 1 var(s)) ---
_PLP_age_ok_1_0:
        PUSH   BP
        MOV   BP, SP
; allocate 1 variable(s) locale(s)
...
; === Predicat man/1 (1 clause(s)) ===
_PLP_man_1:
        JMP   _PLP_man_1_0

; === Predicat woman/1 (1 clause(s)) ===
_PLP_woman_1:
        JMP   _PLP_woman_1_0
...
; === Predicat hello/0 (1 clause(s)) ===

; === Predicat world/0 (1 clause(s)) ===

; === Predicat likes/2 (1 clause(s)) ===
_PLP_likes_2:
        JMP   _PLP_likes_2_0

; === Predicat human/1 (1 clause(s)) ===
_PLP_human_1:
        JMP   _PLP_human_1_0

; === Predicat age_ok/1 (1 clause(s)) ===
_PLP_age_ok_1:
        JMP   _PLP_age_ok_1_0

; === Predicat age/2 (1 clause(s)) ===
_PLP_age_2:
        JMP   _PLP_age_2_0
