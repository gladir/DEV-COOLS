; Genere par PROLOG86 v1.0 - SAMPLES/PROLOG/test_lists.pl
; Date: 2026-03-06
...
; --- Regle pair/1 clause 0 (2 but(s), 2 var(s)) ---
_PLP_pair_1_0:
        PUSH   BP
        MOV   BP, SP
...
; --- Regle make_list/3 clause 0 (1 but(s), 3 var(s)) ---
_PLP_make_list_3_0:
        PUSH   BP
        MOV   BP, SP
...
_PLP_make_list_3_0_F:
        STC
        MOV   SP, BP
        POP   BP
        RET

; --- Fait check/1 clause 0 ---
_PLP_check_1_0:
        PUSH   BP
        MOV   BP, SP
; arg 1/1
...
; --- Regle process/1 clause 0 (1 but(s), 1 var(s)) ---
_PLP_process_1_0:
        PUSH   BP
        MOV   BP, SP
...
_PLP_transform_2_0_F:
        STC
        MOV   SP, BP
        POP   BP
        RET

; --- Fait clear/2 clause 0 ---
_PLP_clear_2_0:
        PUSH   BP
        MOV   BP, SP
; arg 1/2
...
; --- Regle clear/2 clause 1 (1 but(s), 2 var(s)) ---
_PLP_clear_2_1:
        PUSH   BP
        MOV   BP, SP
; allocate 2 variable(s) locale(s)
...
; === Predicat empty/1 (1 clause(s)) ===
_PLP_empty_1:
        JMP   _PLP_empty_1_0

; === Predicat letters/1 (1 clause(s)) ===
_PLP_letters_1:
        JMP   _PLP_letters_1_0

; === Predicat numbers/1 (1 clause(s)) ===
_PLP_numbers_1:
        JMP   _PLP_numbers_1_0

; === Predicat single/1 (1 clause(s)) ===
_PLP_single_1:
        JMP   _PLP_single_1_0

; === Predicat pair/1 (1 clause(s)) ===
_PLP_pair_1:
        JMP   _PLP_pair_1_0

; === Predicat head/1 (1 clause(s)) ===
_PLP_head_1:
        JMP   _PLP_head_1_0

; === Predicat tail/1 (1 clause(s)) ===
_PLP_tail_1:
        JMP   _PLP_tail_1_0

; === Predicat first/2 (1 clause(s)) ===
_PLP_first_2:
        JMP   _PLP_first_2_0

; === Predicat make_list/3 (1 clause(s)) ===
_PLP_make_list_3:
        JMP   _PLP_make_list_3_0

; === Predicat check/1 (1 clause(s)) ===
_PLP_check_1:
        JMP   _PLP_check_1_0

; === Predicat nested/1 (1 clause(s)) ===
_PLP_nested_1:
        JMP   _PLP_nested_1_0

; === Predicat my_head/2 (1 clause(s)) ===
_PLP_my_head_2:
        JMP   _PLP_my_head_2_0

; === Predicat my_tail/2 (1 clause(s)) ===
_PLP_my_tail_2:
        JMP   _PLP_my_tail_2_0

; === Predicat mixed/3 (1 clause(s)) ===
_PLP_mixed_3:
        JMP   _PLP_mixed_3_0

; === Predicat process/1 (1 clause(s)) ===
_PLP_process_1:
        JMP   _PLP_process_1_0

; === Predicat transform/2 (1 clause(s)) ===
_PLP_transform_2:
        JMP   _PLP_transform_2_0

; === Predicat clear/2 (2 clause(s)) ===
_PLP_clear_2:
; Backtracking WAM - 2 clauses

; try_me_else _PLP_clear_2_cp1
        MOV   BX, OFFSET _PLP_clear_2_cp1
        CALL    _PLRT_TRY
        CALL   _PLP_clear_2_0
        JNC   _PLP_clear_2_ok
_PLP_clear_2_cp1:
