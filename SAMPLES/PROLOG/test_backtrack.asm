; Genere par PROLOG86 v1.0 - SAMPLES/PROLOG/test_backtrack.pl
; Date: 2026-03-06
...
; --- Regle colored_fruit/2 clause 0 (2 but(s), 2 var(s)) ---
_PLP_colored_fruit_2_0:
        PUSH   BP
        MOV   BP, SP
...
_PLP_colored_fruit_2_0_F:
        STC
        MOV   SP, BP
        POP   BP
        RET

; --- Regle same_color/2 clause 0 (2 but(s), 2 var(s)) ---
_PLP_same_color_2_0:
        PUSH   BP
        MOV   BP, SP
; allocate 2 variable(s) locale(s)
...
; --- Regle greeting/0 clause 1 (1 but(s), 0 var(s)) ---
_PLP_greeting_0_1:
        PUSH   BP
        MOV   BP, SP
; --- corps de la regle ---

; but 1/1: goodbye_msg/0
; last call optimization
        MOV   SP, BP
        POP   BP
        JMP   _PLP_goodbye_msg_0
...
; --- Fait hello_msg/0 clause 0 ---
_PLP_hello_msg_0:
        CLC
        RET

; --- Fait goodbye_msg/0 clause 0 ---
_PLP_goodbye_msg_0:
        CLC
        RET
...
; === Predicat color/1 (3 clause(s)) ===
_PLP_color_1:
; Backtracking WAM - 3 clauses

; try_me_else _PLP_color_1_cp1
        MOV   BX, OFFSET _PLP_color_1_cp1
        CALL    _PLRT_TRY
        CALL   _PLP_color_1_0
        JNC   _PLP_color_1_ok
_PLP_color_1_cp1:
; retry_me_else _PLP_color_1_cp2
        MOV   BX, OFFSET _PLP_color_1_cp2
        CALL    _PLRT_RETRY
        CALL   _PLP_color_1_1
        JNC   _PLP_color_1_ok
_PLP_color_1_cp2:
...
; === Predicat fruit/1 (4 clause(s)) ===
_PLP_fruit_1:
; Backtracking WAM - 4 clauses

; try_me_else _PLP_fruit_1_cp1
        MOV   BX, OFFSET _PLP_fruit_1_cp1
        CALL    _PLRT_TRY
        CALL   _PLP_fruit_1_0
        JNC   _PLP_fruit_1_ok
_PLP_fruit_1_cp1:
; retry_me_else _PLP_fruit_1_cp2
        MOV   BX, OFFSET _PLP_fruit_1_cp2
        CALL    _PLRT_RETRY
        CALL   _PLP_fruit_1_1
        JNC   _PLP_fruit_1_ok
_PLP_fruit_1_cp2:
; retry_me_else _PLP_fruit_1_cp3
        MOV   BX, OFFSET _PLP_fruit_1_cp3
        CALL    _PLRT_RETRY
        CALL   _PLP_fruit_1_2
        JNC   _PLP_fruit_1_ok
_PLP_fruit_1_cp3:
...
; === Predicat pair/2 (5 clause(s)) ===
_PLP_pair_2:
; Backtracking WAM - 5 clauses

; try_me_else _PLP_pair_2_cp1
        MOV   BX, OFFSET _PLP_pair_2_cp1
        CALL    _PLRT_TRY
        CALL   _PLP_pair_2_0
        JNC   _PLP_pair_2_ok
_PLP_pair_2_cp1:
; retry_me_else _PLP_pair_2_cp2
        MOV   BX, OFFSET _PLP_pair_2_cp2
        CALL    _PLRT_RETRY
        CALL   _PLP_pair_2_1
        JNC   _PLP_pair_2_ok
_PLP_pair_2_cp2:
; retry_me_else _PLP_pair_2_cp3
        MOV   BX, OFFSET _PLP_pair_2_cp3
        CALL    _PLRT_RETRY
        CALL   _PLP_pair_2_2
        JNC   _PLP_pair_2_ok
_PLP_pair_2_cp3:
; retry_me_else _PLP_pair_2_cp4
        MOV   BX, OFFSET _PLP_pair_2_cp4
        CALL    _PLRT_RETRY
        CALL   _PLP_pair_2_3
        JNC   _PLP_pair_2_ok
_PLP_pair_2_cp4:
...
; === Predicat colored_fruit/2 (1 clause(s)) ===
_PLP_colored_fruit_2:
        JMP   _PLP_colored_fruit_2_0

; === Predicat same_color/2 (1 clause(s)) ===
_PLP_same_color_2:
        JMP   _PLP_same_color_2_0

; === Predicat greeting/0 (2 clause(s)) ===
_PLP_greeting_0:
; try_me_else _PLP_greeting_0_cp1
        MOV   BX, OFFSET _PLP_greeting_0_cp1
        CALL    _PLRT_TRY
        CALL   _PLP_greeting_0_0
        JNC   _PLP_greeting_0_ok
_PLP_greeting_0_cp1:
; trust_me
        CALL    _PLRT_TRUST
        CALL   _PLP_greeting_0_1
        RET
_PLP_greeting_0_ok:
; Succes : retirer le choice point (commit)
        PUSH   SI
...
; === Predicat hello_msg/0 (1 clause(s)) ===

; === Predicat goodbye_msg/0 (1 clause(s)) ===
