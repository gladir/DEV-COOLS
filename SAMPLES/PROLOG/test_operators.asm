; Genere par PROLOG86 v1.0 - SAMPLES/PROLOG/test_operators.pl
; Date: 2026-03-06
...
; --- Regle test_op_define/0 clause 0 (3 but(s), 0 var(s)) ---
_PLP_test_op_define_0_0:
        PUSH   BP
        MOV   BP, SP
; --- corps de la regle ---
...
_PLP_test_op_define_0_0_F:
        STC
        MOV   SP, BP
        POP   BP
        RET

; --- Regle test_current_op_std/0 clause 0 (6 but(s), 2 var(s)) ---
_PLP_test_current_op_std_0_0:
        PUSH   BP
        MOV   BP, SP
...
; but 1/6: current_op/3
; current_op/3 inline (TODO 21)
...
_PLP_test_current_op_std_0_0_F:
        STC
        MOV   SP, BP
        POP   BP
        RET

; --- Regle test_current_op_plus/0 clause 0 (6 but(s), 2 var(s)) ---
_PLP_test_current_op_plus_0_0:
        PUSH   BP
        MOV   BP, SP
; allocate 2 variable(s) locale(s)
        SUB   SP, 4
...
_PLP_test_current_op_plus_0_0_F:
        STC
        MOV   SP, BP
        POP   BP
        RET

; --- Regle test_current_op_eq/0 clause 0 (6 but(s), 2 var(s)) ---
_PLP_test_current_op_eq_0_0:
        PUSH   BP
        MOV   BP, SP
; allocate 2 variable(s) locale(s)
        SUB   SP, 4
...
_PLP_test_current_op_eq_0_0_F:
        STC
        MOV   SP, BP
        POP   BP
        RET

; --- Regle test_op_new/0 clause 0 (7 but(s), 2 var(s)) ---
_PLP_test_op_new_0_0:
        PUSH   BP
        MOV   BP, SP
; allocate 2 variable(s) locale(s)
        SUB   SP, 4
...
; === Predicat test_op_define/0 (1 clause(s)) ===

; === Predicat test_current_op_std/0 (1 clause(s)) ===

; === Predicat test_current_op_plus/0 (1 clause(s)) ===

; === Predicat test_current_op_eq/0 (1 clause(s)) ===

; === Predicat test_op_new/0 (1 clause(s)) ===
