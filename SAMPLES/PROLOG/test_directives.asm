; Genere par PROLOG86 v1.0 - SAMPLES/PROLOG/test_directives.pl
; Date: 2026-03-06
...
; === Predicat greet/1 (1 clause(s)) ===
_PLP_greet_1:
        JMP   _PLP_greet_1_0

; === Predicat counter/1 (1 clause(s)) ===
_PLP_counter_1:
        JMP   _PLP_counter_1_0

; === Predicat memo/2 (1 clause(s)) ===
_PLP_memo_2:
        JMP   _PLP_memo_2_0

; === Predicat fact/1 (1 clause(s)) ===
_PLP_fact_1:
        JMP   _PLP_fact_1_0
