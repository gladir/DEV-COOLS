; Genere par PROLOG86 v1.0 - SAMPLES/PROLOG/test_dyndb.pl
; Date: 2026-03-06
...
; --- Regle test_assertz/0 clause 0 (3 but(s), 0 var(s)) ---
_PLP_test_assertz_0_0:
        PUSH   BP
        MOV   BP, SP
; --- corps de la regle ---
...
_PLP_test_assertz_0_0_F:
        STC
        MOV   SP, BP
        POP   BP
        RET

; --- Regle test_asserta/0 clause 0 (3 but(s), 0 var(s)) ---
_PLP_test_asserta_0_0:
        PUSH   BP
        MOV   BP, SP
; --- corps de la regle ---

; but 1/3: asserta/1
; asserta/1 inline (TODO 19)
        MOV   AX, 8202
; atom fish
        CALL    _PLRT_ASSERTA
; asserta/1 done
...
; --- Regle test_abolish/0 clause 0 (3 but(s), 0 var(s)) ---
_PLP_test_abolish_0_0:
        PUSH   BP
        MOV   BP, SP
; --- corps de la regle ---

; but 1/3: abolish/1
; abolish/1 inline (TODO 19)
        MOV   AX, 8202
; atom fish
        CALL    _PLRT_ABOLISH
; abolish/1 done
...
; === Predicat test_assertz/0 (1 clause(s)) ===

; === Predicat test_asserta/0 (1 clause(s)) ===

; === Predicat test_retract/0 (1 clause(s)) ===

; === Predicat test_abolish/0 (1 clause(s)) ===
