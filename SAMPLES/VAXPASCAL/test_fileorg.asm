...
; Source : SAMPLES\VAXPASCAL\test_fileorg.pas
; ========================================
...
_VXP_F  DW  0
_VXPK_3  DB  'students.dat',0
_VXPK_5  DB  'students.dat',0
_VXPK_11  DB  ' - age ',0
_VXPK_12  DB  ' - note ',0
_VXPK_13  DB  'Test file org termine.',0
_DATA   ENDS
