...
; Source : SAMPLES/VAXPASCAL/test_if.pas
...
; assign grade
        LEA   EAX, _VXPK_12
        MOV   BYTE PTR [_VXP_GRADE], AL
; case
        MOVZX   EAX, BYTE PTR [_VXP_GRADE]
        PUSH   EAX
        LEA   EAX, _VXPK_16
...
_VXP_X  DD  0
_VXP_GRADE  DB  0
_VXPK_6  DB  'x est positif',0
_VXPK_10  DB  'x est zero',0
_VXPK_11  DB  'x est negatif',0
_VXPK_12  DB  'B',0
_VXPK_16  DB  'A',0
_VXPK_17  DB  'Excellent',0
_VXPK_20  DB  'B',0
_VXPK_21  DB  'Bien',0
_VXPK_24  DB  'C',0
_VXPK_25  DB  'Moyen',0
_VXPK_28  DB  'D',0
_VXPK_29  DB  'F',0
_VXPK_30  DB  'Insuffisant',0
_VXPK_31  DB  'Note inconnue',0
_VXPK_35  DB  'petit',0
_VXPK_38  DB  'moyen',0
_VXPK_41  DB  'grand',0
_VXPK_42  DB  'hors plage',0
_DATA   ENDS
        END     _VXPF_MAIN
