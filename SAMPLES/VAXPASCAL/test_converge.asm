...
; Source : SAMPLES\VAXPASCAL\test_converge.pas
; ========================================
...
; exception: sauvegarder handler parent
        ...
        MOV   WORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_3
...
; exception: sauvegarder handler parent
        ...
        PUSH   WORD PTR [_VXPRT_EXCSP]
        PUSH   WORD PTR [_VXPRT_EXCBP]
        MOV   WORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_9
        MOV   WORD PTR [_VXPRT_EXCSP], SP
        MOV   WORD PTR [_VXPRT_EXCBP], BP
; assign count
        MOV   AX, WORD PTR [_VXP_COUNT]
        PUSH   AX
        MOV   AX, 1
        MOV   BX, AX
        POP   AX
        ADD   AX, BX
        MOV   WORD PTR [_VXP_COUNT], AX
; writeln
        LEA   AX, _VXPK_11
        MOV   SI, AX
...
; exception: sauvegarder handler parent
        ...
        PUSH   WORD PTR [_VXPRT_EXCSP]
        PUSH   WORD PTR [_VXPRT_EXCBP]
        MOV   WORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_12
        MOV   WORD PTR [_VXPRT_EXCSP], SP
        MOV   WORD PTR [_VXPRT_EXCBP], BP
; writeln
        XOR   AX, AX
...
_VXPL_18:
; assign sum
        MOV   AX, WORD PTR [_VXP_SUM]
        PUSH   AX
        MOV   AX, WORD PTR [_VXP_I]
        SUB   AX, 1
        SHL   AX, 1
        MOV   BX, OFFSET _VXP_ARR
        ADD   BX, AX
        MOV   AX, WORD PTR [BX]
        MOV   BX, AX
        POP   AX
...
; set constructor
        ...
        MOV   SI, OFFSET _VXPRT_SETBUF
        CALL   _VXPRT_SET_ADD
        MOV   AX, OFFSET _VXPRT_SETBUF
        MOV   SI, AX
        MOV   DI, OFFSET _VXP_COLORS
        CALL   _VXPRT_SET_COPY
; if
        MOV   AX, OFFSET _VXP_COLORS
        MOV   BX, AX
        MOV   AX, 1
; element IN set
        MOV   SI, BX
...
; for
        ...
        MOV   WORD PTR [_VXP_I], AX
        MOV   AX, 3
        MOV   WORD PTR [_VXPL_38], AX
_VXPL_39:
        MOV   AX, WORD PTR [_VXP_I]
        CMP   AX, WORD PTR [_VXPL_38]
        JG   _VXPL_40
; call tick
        CALL   _VXPF_TICK
_VXPL_41:
...
; new
        MOV   AX, 2
        CALL   _VXPRT_NEW
        MOV   WORD PTR [_VXP_PTR], AX
; assign ptr^
        MOV   AX, 999
        MOV   BX, WORD PTR [_VXP_PTR]
        MOV   WORD PTR [BX], AX
; writeln
        LEA   AX, _VXPK_42
        MOV   SI, AX
...
_VXPL_48:
        CMP   AX, 0
        JE   _VXPL_49
        MOV   SI, OFFSET _VXPRT_TRUE_S
        JMP   _VXPL_50
_VXPL_49:
        MOV   SI, OFFSET _VXPRT_FALSE_S
_VXPL_50:
        CALL   _VXPRT_PRINTSTR
        XOR   AX, AX
        CALL   _VXPRT_NUMTOSTR
...
_VXPL_16  DW  0
_VXPK_20  DB  'Sum of squares 1..',0
_VXPK_21  DB  ' = ',0
_VXPK_24  DB  'Point : (',0
_VXPK_25  DB  ', ',0
_VXPK_26  DB  ')',0
_VXPK_29  DB  'Green present',0
_VXPK_30  DB  'Green absent',0
_VXPK_31  DB  'Card = ',0
_VXPK_32  DB  'Hello',0
_VXPK_33  DB  ' ',0
_VXPK_34  DB  'World',0
_VXPK_35  DB  's = ',0
_VXPK_36  DB  'length = ',0
_VXPK_37  DB  'fib(10) = ',0
_VXPL_38  DW  0
_VXPK_42  DB  'ptr^ = ',0
_VXPK_45  DB  'ok = ',0
_VXPK_46  DB  'test_condition intercepte',0
_VXPK_47  DB  'Erreur inattendue',0
_VXPK_51  DB  ' ',0
_VXPK_54  DB  ' ',0
_VXPK_56  DB  'Tous les tests convergent. OK.',0
_DATA   ENDS
