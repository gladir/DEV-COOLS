...
; Source : SAMPLES/VAXPASCAL/test_record.pas
...
; writeln
        ...
        CALL   _VXPRT_PRINTSTR
; field pers.*
        MOV   EAX, DWORD PTR [_VXPR_PERS]
        CALL   _VXPRT_PRINTINT
        LEA   EAX, _VXPK_9
        MOV   ESI, EAX
        CALL   _VXPRT_PRINTSTR
; field pers.*
        MOV   EBX, OFFSET _VXPR_PERS
        ADD   EBX, 4
        MOV   EAX, DWORD PTR [EBX]
        CALL   _VXPRT_PRINTINT
        CALL   _VXPRT_NEWLINE
; assign s.kind
        MOV   EAX, 2
        MOV   DWORD PTR [_VXPR_S], EAX
; assign s.width
        MOV   EAX, 100
        MOV   EBX, OFFSET _VXPR_S
        ADD   EBX, 4
        MOV   DWORD PTR [EBX], EAX
; assign s.height
        MOV   EAX, 50
