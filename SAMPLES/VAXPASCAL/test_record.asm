...
; Source : SAMPLES\VAXPASCAL\test_record.pas
; ========================================
...
; exception: sauvegarder handler parent
        ...
        PUSH   WORD PTR [_VXPRT_EXCSP]
        PUSH   WORD PTR [_VXPRT_EXCBP]
        MOV   WORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_6
        MOV   WORD PTR [_VXPRT_EXCSP], SP
        MOV   WORD PTR [_VXPRT_EXCBP], BP
; with assign name
        LEA   AX, _VXPK_8
        MOV   BX, OFFSET _VXPR_PERS
        MOV   WORD PTR [BX], AX
; with assign age
        MOV   AX, 30
        MOV   BX, OFFSET _VXPR_PERS
...
; assign s.kind
        MOV   AX, 2
        MOV   WORD PTR [_VXPR_S], AX
; assign s.width
        MOV   AX, 100
        MOV   BX, OFFSET _VXPR_S
        ADD   BX, 2
        MOV   WORD PTR [BX], AX
; assign s.height
        MOV   AX, 50
