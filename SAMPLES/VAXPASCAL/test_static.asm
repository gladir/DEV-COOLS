...
; Source : SAMPLES\VAXPASCAL\test_static.pas
; ========================================
...
; for
        ...
        MOV   AX, 5
        MOV   WORD PTR [_VXPL_7], AX
_VXPL_8:
        MOV   AX, WORD PTR [_VXP_I]
        CMP   AX, WORD PTR [_VXPL_7]
        JG   _VXPL_9
; call counter
        CALL   _VXPF_COUNTER
_VXPL_10:
...
; assign flag
        MOV   AX, 1
        MOV   WORD PTR [_VXP_FLAG], AX
; writeln
        LEA   AX, _VXPK_11
        MOV   SI, AX
        CALL   _VXPRT_PRINTSTR
        MOV   AX, WORD PTR [_VXP_FLAG]
        CALL   _VXPRT_NUMTOSTR
        MOV   SI, OFFSET _VXPRT_NUMBUF
        CALL   _VXPRT_PRINTSTR
        MOV   SI, OFFSET _VXPRT_CRLF
