...
; Source : SAMPLES\VAXPASCAL\test_module.pas
; ========================================
...
; assign retval get_counter
        MOV   AX, WORD PTR [_VXP_SHARED_COUNTER]
...
_VXPL_1:
        ...
        POP   BP
        RET
_VXPF_GET_COUNTER   ENDP

        PUBLIC _VXPF_INC_COUNTER

; --- inc_counter ---
_VXPF_INC_COUNTER   PROC NEAR
        PUSH   BP
        MOV   BP, SP
        PUSH   SI
        PUSH   DI
...
; assign shared_counter
        ...
        POP   AX
        ADD   AX, BX
        MOV   WORD PTR [_VXP_SHARED_COUNTER], AX
; exception: pas d erreur, restaurer handler parent
        POP   WORD PTR [_VXPRT_EXCBP]
        POP   WORD PTR [_VXPRT_EXCSP]
        POP   WORD PTR [_VXPRT_EXCHDL]
...
_VXPL_4:
        ...
        POP   BP
        RET
_VXPF_INC_COUNTER   ENDP

        PUBLIC _VXPF_SET_COUNTER

; --- set_counter ---
_VXPF_SET_COUNTER   PROC NEAR
        PUSH   BP
        MOV   BP, SP
        PUSH   SI
        PUSH   DI
