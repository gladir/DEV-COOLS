...
; Source : SAMPLES/VAXPASCAL/test_funcproc.pas
...
; exception: sauvegarder handler parent
        ...
        PUSH   DWORD PTR [_VXPRT_EXCSP]
        PUSH   DWORD PTR [_VXPRT_EXCBP]
        MOV   DWORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_6
        MOV   DWORD PTR [_VXPRT_EXCSP], ESP
        MOV   DWORD PTR [_VXPRT_EXCBP], EBP
; writeln
...
; exception: sauvegarder handler parent
        ...
        PUSH   DWORD PTR [_VXPRT_EXCSP]
        PUSH   DWORD PTR [_VXPRT_EXCBP]
        MOV   DWORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_21
        MOV   DWORD PTR [_VXPRT_EXCSP], ESP
        MOV   DWORD PTR [_VXPRT_EXCBP], EBP
...
; exception: sauvegarder handler parent
        ...
        PUSH   DWORD PTR [_VXPRT_EXCSP]
        PUSH   DWORD PTR [_VXPRT_EXCBP]
        MOV   DWORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_24
        MOV   DWORD PTR [_VXPRT_EXCSP], ESP
        MOV   DWORD PTR [_VXPRT_EXCBP], EBP
; if
        MOV   EAX, DWORD PTR [EBP+8]
...
; exception: sauvegarder handler parent
        ...
        PUSH   DWORD PTR [_VXPRT_EXCSP]
        PUSH   DWORD PTR [_VXPRT_EXCBP]
        MOV   DWORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_34
        MOV   DWORD PTR [_VXPRT_EXCSP], ESP
        MOV   DWORD PTR [_VXPRT_EXCBP], EBP
; assign retval Fwd
        MOV   EAX, DWORD PTR [EBP+8]
...
; exception: sauvegarder handler parent
        ...
        PUSH   DWORD PTR [_VXPRT_EXCSP]
        PUSH   DWORD PTR [_VXPRT_EXCBP]
        MOV   DWORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_36
        MOV   DWORD PTR [_VXPRT_EXCSP], ESP
        MOV   DWORD PTR [_VXPRT_EXCBP], EBP
; call SayHello
        CALL   _VXPF_SAYHELLO
...
_VXP_R  DD  0
_VXPK_4  DB  'Hello from proc',0
_VXPK_31  DB  'exit early',0
_VXPK_32  DB  'not reached if 0',0
_VXPK_38  DB  'PrintVal: ',0
_VXPK_39  DB  'Double 7 = ',0
_VXPK_40  DB  'Triple 5 = ',0
_VXPK_41  DB  '3+4 = ',0
_VXPK_42  DB  '3^2+4^2 = ',0
_VXPK_43  DB  'Fwd 5 = ',0
_VXPK_44  DB  'Tous les tests TODO 14 OK',0
_DATA   ENDS
        END     _VXPF_MAIN
