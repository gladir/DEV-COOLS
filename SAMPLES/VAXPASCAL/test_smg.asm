...
; Source : SAMPLES\VAXPASCAL\test_smg.pas
; ========================================
...
; exception: sauvegarder handler parent
        ...
        MOV   WORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_1
        MOV   WORD PTR [_VXPRT_EXCSP], SP
        MOV   WORD PTR [_VXPRT_EXCBP], BP
; assign status
        EXTRN  _VXPF_SMG$CREATE_PASTEBOARD:NEAR
; call smg$create_pasteboard
        MOV   AX, WORD PTR [_VXP_PASTEBOARD]
        PUSH   AX
        CALL   _VXPF_SMG$CREATE_PASTEBOARD
        MOV   WORD PTR [_VXPRT_STATUS], AX
; writeln
        LEA   AX, _VXPK_3
        MOV   SI, AX
        CALL   _VXPRT_PRINTSTR
        MOV   AX, WORD PTR [_VXPRT_IOSTATUS]
        ...
        CALL   _VXPRT_PRINTSTR
; assign status
        EXTRN  _VXPF_SMG$CREATE_VIRTUAL_DISPLAY:NEAR
; call smg$create_virtual_display
        MOV   AX, 24
        PUSH   AX
        MOV   AX, 80
        PUSH   AX
        MOV   AX, WORD PTR [_VXP_DISPLAY_ID]
        PUSH   AX
        CALL   _VXPF_SMG$CREATE_VIRTUAL_DISPLAY
        MOV   WORD PTR [_VXPRT_STATUS], AX
; writeln
        LEA   AX, _VXPK_4
        MOV   SI, AX
        ...
        CALL   _VXPRT_PRINTSTR
; assign status
        EXTRN  _VXPF_SMG$CREATE_VIRTUAL_KEYBOARD:NEAR
; call smg$create_virtual_keyboard
        MOV   AX, WORD PTR [_VXP_KEYBOARD_ID]
        PUSH   AX
        CALL   _VXPF_SMG$CREATE_VIRTUAL_KEYBOARD
        MOV   WORD PTR [_VXPRT_STATUS], AX
; writeln
        LEA   AX, _VXPK_5
        MOV   SI, AX
        ...
        CALL   _VXPRT_PRINTSTR
; assign status
        EXTRN  _VXPF_SMG$PASTE_VIRTUAL_DISPLAY:NEAR
; call smg$paste_virtual_display
        ...
        MOV   AX, 1
        PUSH   AX
        CALL   _VXPF_SMG$PASTE_VIRTUAL_DISPLAY
        MOV   WORD PTR [_VXPRT_STATUS], AX
; writeln
        LEA   AX, _VXPK_6
        MOV   SI, AX
        ...
        CALL   _VXPRT_PRINTSTR
; assign status
        EXTRN  _VXPF_SMG$PUT_CHARS:NEAR
; call smg$put_chars
        MOV   AX, WORD PTR [_VXP_DISPLAY_ID]
        PUSH   AX
        LEA   AX, _VXPK_7
...
; writeln
        ...
        CALL   _VXPRT_PRINTSTR
; assign status
        EXTRN  _VXPF_SMG$DELETE_VIRTUAL_DISPLAY:NEAR
; call smg$delete_virtual_display
        MOV   AX, WORD PTR [_VXP_DISPLAY_ID]
        PUSH   AX
        CALL   _VXPF_SMG$DELETE_VIRTUAL_DISPLAY
        MOV   WORD PTR [_VXPRT_STATUS], AX
; writeln
        LEA   AX, _VXPK_9
        MOV   SI, AX
        ...
        CALL   _VXPRT_PRINTSTR
; assign status
        EXTRN  _VXPF_SMG$DELETE_PASTEBOARD:NEAR
; call smg$delete_pasteboard
        MOV   AX, WORD PTR [_VXP_PASTEBOARD]
        PUSH   AX
        CALL   _VXPF_SMG$DELETE_PASTEBOARD
        MOV   WORD PTR [_VXPRT_STATUS], AX
; writeln
        LEA   AX, _VXPK_10
        MOV   SI, AX
...
_VXP_DISPLAY_ID  DW  0
_VXP_PASTEBOARD  DW  0
_VXP_KEYBOARD_ID  DW  0
_VXPRT_STATUS  DW  0
_VXPK_3  DB  'smg$create_pasteboard status = ',0
_VXPK_4  DB  'smg$create_virtual_display status = ',0
_VXPK_5  DB  'smg$create_virtual_keyboard status = ',0
_VXPK_6  DB  'smg$paste_virtual_display status = ',0
_VXPK_7  DB  'Hello SMG!',0
_VXPK_8  DB  'smg$put_chars status = ',0
_VXPK_9  DB  'smg$delete_virtual_display status = ',0
_VXPK_10  DB  'smg$delete_pasteboard status = ',0
_VXPK_11  DB  'Test SMG stubs termine.',0
_DATA   ENDS
