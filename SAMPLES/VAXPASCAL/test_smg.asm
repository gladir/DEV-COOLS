...
; Source : SAMPLES/VAXPASCAL/test_smg.pas
...
; assign status
        XOR   EAX, EAX
        MOV   DWORD PTR [_VXPRT_STATUS], EAX
; writeln
        LEA   EAX, _VXPK_3
        MOV   ESI, EAX
...
_VXP_DISPLAY_ID  DD  0
_VXP_PASTEBOARD  DD  0
_VXP_KEYBOARD_ID  DD  0
_VXPRT_STATUS  DD  0
...
_VXPK_7  DB  'smg$put_chars status = ',0
_VXPK_8  DB  'smg$delete_virtual_display status = ',0
_VXPK_9  DB  'smg$delete_pasteboard status = ',0
_VXPK_10  DB  'Test SMG stubs termine.',0
_DATA   ENDS
        END     _VXPF_MAIN
