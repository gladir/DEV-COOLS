...
; Source : SAMPLES\VAXPASCAL\test_datetime.pas
; ========================================
...
; date
        CALL   _VXPRT_DATE
        LEA   SI, _VXPRT_DATEBUF
        MOV   DI, OFFSET _VXP_D
        CALL   _VXPRT_STRCPY
; writeln
        LEA   AX, _VXPK_3
        MOV   SI, AX
        CALL   _VXPRT_PRINTSTR
        MOV   AX, WORD PTR [_VXP_D]
...
; time
        CALL   _VXPRT_TIME
        LEA   SI, _VXPRT_TIMEBUF
        MOV   DI, OFFSET _VXP_T
        CALL   _VXPRT_STRCPY
; writeln
        LEA   AX, _VXPK_4
        MOV   SI, AX
        CALL   _VXPRT_PRINTSTR
        MOV   AX, WORD PTR [_VXP_T]
        CALL   _VXPRT_NUMTOSTR
        MOV   SI, OFFSET _VXPRT_NUMBUF
        CALL   _VXPRT_PRINTSTR
        MOV   SI, OFFSET _VXPRT_CRLF
...
; assign clk
        CALL   _VXPRT_CLOCK
        MOV   WORD PTR [_VXP_CLK], AX
; writeln
        LEA   AX, _VXPK_5
        MOV   SI, AX
        CALL   _VXPRT_PRINTSTR
        MOV   AX, WORD PTR [_VXP_CLK]
        CALL   _VXPRT_NUMTOSTR
        MOV   SI, OFFSET _VXPRT_NUMBUF
        CALL   _VXPRT_PRINTSTR
        MOV   SI, OFFSET _VXPRT_CRLF
        CALL   _VXPRT_PRINTSTR
; assign wc
        CALL   _VXPRT_WALLCLOCK
        MOV   WORD PTR [_VXP_WC], AX
; writeln
        LEA   AX, _VXPK_6
        MOV   SI, AX
        CALL   _VXPRT_PRINTSTR
        MOV   AX, WORD PTR [_VXP_WC]
        CALL   _VXPRT_NUMTOSTR
        MOV   SI, OFFSET _VXPRT_NUMBUF
        CALL   _VXPRT_PRINTSTR
        MOV   SI, OFFSET _VXPRT_CRLF
...
_VXPK_4  DB  'Time   = ',0
_VXPK_5  DB  'Clock  = ',0
_VXPK_6  DB  'Wallclock = ',0
_VXPK_7  DB  'Test date/time termine.',0
_DATA   ENDS
