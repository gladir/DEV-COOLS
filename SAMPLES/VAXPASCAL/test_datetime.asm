...
; Source : SAMPLES/VAXPASCAL/test_datetime.pas
...
; assign clk
        ...
        MOV   DWORD PTR [_VXP_CLK], EAX
; writeln
        LEA   EAX, _VXPK_5
        MOV   ESI, EAX
        CALL   _VXPRT_PRINTSTR
        MOV   EAX, DWORD PTR [_VXP_CLK]
        CALL   _VXPRT_PRINTINT
        CALL   _VXPRT_NEWLINE
; assign wc
        MOV   EAX, DWORD PTR [EBP+0]
        MOV   DWORD PTR [_VXP_WC], EAX
; writeln
        LEA   EAX, _VXPK_6
        MOV   ESI, EAX
        CALL   _VXPRT_PRINTSTR
        MOV   EAX, DWORD PTR [_VXP_WC]
        CALL   _VXPRT_PRINTINT
        CALL   _VXPRT_NEWLINE
; writeln
        LEA   EAX, _VXPK_7
