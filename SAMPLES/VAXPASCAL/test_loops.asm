...
; Source : SAMPLES/VAXPASCAL/test_loops.pas
...
; assign S
        XOR   EAX, EAX
        MOV   DWORD PTR [_VXP_S], EAX
; for
        MOV   EAX, 1
        MOV   DWORD PTR [_VXP_I], EAX
        MOV   EAX, 5
        MOV   DWORD PTR [_VXPL_3], EAX
_VXPL_4:
        MOV   EAX, DWORD PTR [_VXP_I]
        CMP   EAX, DWORD PTR [_VXPL_3]
        JG   _VXPL_5
; assign S
        MOV   EAX, DWORD PTR [_VXP_S]
        PUSH   EAX
        MOV   EAX, DWORD PTR [_VXP_I]
        MOV   EBX, EAX
        POP   EAX
...
; for
        ...
        MOV   DWORD PTR [_VXP_I], EAX
        MOV   EAX, 1
        MOV   DWORD PTR [_VXPL_8], EAX
_VXPL_9:
        MOV   EAX, DWORD PTR [_VXP_I]
        CMP   EAX, DWORD PTR [_VXPL_8]
        JL   _VXPL_10
; assign S
        MOV   EAX, DWORD PTR [_VXP_S]
        PUSH   EAX
...
; for
        ...
        MOV   DWORD PTR [_VXP_I], EAX
        MOV   EAX, 3
        MOV   DWORD PTR [_VXPL_13], EAX
_VXPL_14:
        MOV   EAX, DWORD PTR [_VXP_I]
        CMP   EAX, DWORD PTR [_VXPL_13]
        JG   _VXPL_15
; exception: sauvegarder handler parent
        PUSH   DWORD PTR [_VXPRT_EXCHDL]
        PUSH   DWORD PTR [_VXPRT_EXCSP]
        PUSH   DWORD PTR [_VXPRT_EXCBP]
        MOV   DWORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_17
        MOV   DWORD PTR [_VXPRT_EXCSP], ESP
        MOV   DWORD PTR [_VXPRT_EXCBP], EBP
; assign S
        MOV   EAX, DWORD PTR [_VXP_S]
...
; for
        ...
        MOV   DWORD PTR [_VXP_I], EAX
        MOV   EAX, 10
        MOV   DWORD PTR [_VXPL_20], EAX
        MOV   EAX, 2
        MOV   DWORD PTR [_VXPL_21], EAX
_VXPL_22:
        MOV   EAX, DWORD PTR [_VXP_I]
        CMP   EAX, DWORD PTR [_VXPL_20]
        JG   _VXPL_23
; assign S
        MOV   EAX, DWORD PTR [_VXP_S]
        PUSH   EAX
...
; exception: sauvegarder handler parent
        ...
        PUSH   DWORD PTR [_VXPRT_EXCSP]
        PUSH   DWORD PTR [_VXPRT_EXCBP]
        MOV   DWORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_29
        MOV   DWORD PTR [_VXPRT_EXCSP], ESP
        MOV   DWORD PTR [_VXPRT_EXCBP], EBP
; assign I
        MOV   EAX, DWORD PTR [_VXP_I]
...
; for
        ...
        MOV   DWORD PTR [_VXP_I], EAX
        MOV   EAX, 100
        MOV   DWORD PTR [_VXPL_40], EAX
_VXPL_41:
        MOV   EAX, DWORD PTR [_VXP_I]
        CMP   EAX, DWORD PTR [_VXPL_40]
        JG   _VXPL_42
; exception: sauvegarder handler parent
        PUSH   DWORD PTR [_VXPRT_EXCHDL]
        PUSH   DWORD PTR [_VXPRT_EXCSP]
        PUSH   DWORD PTR [_VXPRT_EXCBP]
        MOV   DWORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_44
        MOV   DWORD PTR [_VXPRT_EXCSP], ESP
        MOV   DWORD PTR [_VXPRT_EXCBP], EBP
; if
        MOV   EAX, DWORD PTR [_VXP_I]
...
; for
        ...
        MOV   DWORD PTR [_VXP_I], EAX
        MOV   EAX, 5
        MOV   DWORD PTR [_VXPL_50], EAX
_VXPL_51:
        MOV   EAX, DWORD PTR [_VXP_I]
        CMP   EAX, DWORD PTR [_VXPL_50]
        JG   _VXPL_52
; exception: sauvegarder handler parent
        PUSH   DWORD PTR [_VXPRT_EXCHDL]
        PUSH   DWORD PTR [_VXPRT_EXCSP]
        PUSH   DWORD PTR [_VXPRT_EXCBP]
        MOV   DWORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_54
        MOV   DWORD PTR [_VXPRT_EXCSP], ESP
        MOV   DWORD PTR [_VXPRT_EXCBP], EBP
; if
        MOV   EAX, DWORD PTR [_VXP_I]
...
_VXP_S  DD  0
_VXPL_3  DD  0
_VXPK_7  DB  'FOR TO sum 1..5 = ',0
_VXPL_8  DD  0
_VXPK_12  DB  'FOR DOWNTO sum 5..1 = ',0
_VXPL_13  DD  0
_VXPK_19  DB  'FOR block sum = ',0
_VXPL_20  DD  0
_VXPL_21  DD  0
_VXPK_25  DB  'FOR BY 2 count = ',0
_VXPK_31  DB  'WHILE sum = ',0
_VXPK_35  DB  'REPEAT sum = ',0
_VXPK_39  DB  'LOOP sum = ',0
_VXPL_40  DD  0
_VXPK_49  DB  'FOR+BREAK sum 1..3 = ',0
_VXPL_50  DD  0
_VXPK_59  DB  'FOR+CONTINUE skip 3 = ',0
_VXPK_60  DB  'Tous les tests TODO 13 OK',0
_DATA   ENDS
        END     _VXPF_MAIN
