...
_VXPL_1:
        ...
        POP   BP
        RET   2
_VXPF_DOUBLE_VAL   ENDP


; --- add_vals ---
_VXPF_ADD_VALS   PROC NEAR
        PUSH   BP
        MOV   BP, SP
        SUB   SP, 2
        PUSH   SI
...
; call double_val
        MOV   AX, 21
        PUSH   AX
        CALL   _VXPF_DOUBLE_VAL
        MOV   WORD PTR [_VXP_RESULT], AX
; writeln
        LEA   AX, _VXPK_13
        MOV   SI, AX
        CALL   _VXPRT_PRINTSTR
        MOV   AX, WORD PTR [_VXP_RESULT]
        CALL   _VXPRT_NUMTOSTR
        MOV   SI, OFFSET _VXPRT_NUMBUF
        CALL   _VXPRT_PRINTSTR
        MOV   SI, OFFSET _VXPRT_CRLF
...
_VXP_RESULT  DW  0
_VXPK_10  DB  'val = ',0
_VXPK_13  DB  'double_val(21) = ',0
_VXPK_14  DB  'add_vals(10, 32) = ',0
_VXPK_15  DB  'Test fonctions termine.',0
_DATA   ENDS
