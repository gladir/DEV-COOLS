...
; Source : SAMPLES/VAXPASCAL/test_assert.pas
...
_VXPL_3:
        CMP   EAX, 0
        JNE   _VXPL_ASSOK_3
        MOV   ESI, OFFSET _VXPRT_ASSERTMSG
...
_VXP_X  DD  0
_VXP_Y  DD  0
_VXPK_5  DB  'Assert x = y : OK',0
_VXPK_8  DB  'Assert x > 0 : OK',0
_VXPK_11  DB  'Assert x + y = 20 : OK',0
_VXPK_12  DB  'Toutes les assertions passees.',0
_DATA   ENDS
        END     _VXPF_MAIN
