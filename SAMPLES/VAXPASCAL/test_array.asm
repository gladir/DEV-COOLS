...
; for
        ...
        MOV   WORD PTR [_VXP_I], AX
        MOV   AX, 10
        MOV   WORD PTR [_VXPL_8], AX
_VXPL_9:
        MOV   AX, WORD PTR [_VXP_I]
        CMP   AX, WORD PTR [_VXPL_8]
        JG   _VXPL_10
; exception: sauvegarder handler parent
        PUSH   WORD PTR [_VXPRT_EXCHDL]
        PUSH   WORD PTR [_VXPRT_EXCSP]
...
_VXP_SUM  DW  0
_VXPL_3  DW  0
_VXPK_7  DB  'Tableau a :',0
_VXPK_14  DB  ' ',0
_VXPL_8  DW  0
_VXPK_15  DB  'Sum = ',0
_VXPK_16  DB  'lowerbound = 1',0
_VXPK_17  DB  'upperbound = 10',0
_VXPK_18  DB  'Test tableaux termine.',0
_DATA   ENDS
