...
; Source : SAMPLES\VAXPASCAL\test_io.pas
; ========================================
...
; open(f, ...)
        ...
        MOV   AX, 0FFFFh
_VXPL_6:
        MOV   WORD PTR [_VXP_F + 0], AX
        MOV   WORD PTR [_VXP_F + 2], 1
; writeln
        MOV   AX, WORD PTR [_VXP_F + 0]
        MOV   WORD PTR [_VXPRT_CURHDL], AX
        LEA   AX, _VXPK_7
        MOV   SI, AX
        CALL   _VXPRT_FWRSTR
        MOV   SI, OFFSET _VXPRT_CRLF
...
; writeln
        ...
        CALL   _VXPRT_FWRSTR
; close(f)
        MOV   BX, WORD PTR [_VXP_F + 0]
        MOV   AH, 3Eh
        INT    21h
        MOV   WORD PTR [_VXP_F + 0], 0FFFFh
        MOV   WORD PTR [_VXP_F + 2], 0
; writeln
        LEA   AX, _VXPK_10
        MOV   SI, AX
        CALL   _VXPRT_PRINTSTR
...
; exception: sauvegarder handler parent
        ...
        PUSH   WORD PTR [_VXPRT_EXCSP]
        PUSH   WORD PTR [_VXPRT_EXCBP]
        MOV   WORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_15
        MOV   WORD PTR [_VXPRT_EXCSP], SP
        MOV   WORD PTR [_VXPRT_EXCBP], BP
; readln
        MOV   AX, WORD PTR [_VXP_F + 0]
        ...
        CALL   _VXPRT_FRDCHAR
        XOR   AH, AH
        MOV   BYTE PTR [_VXPRT_STRBUF], AL
        MOV   BYTE PTR [_VXPRT_STRBUF + 1], 0
        LEA   SI, _VXPRT_STRBUF
        MOV   DI, OFFSET 
        MOV   CX, 2
        REP    MOVSB
; readln: flush reste de ligne
        CALL   _VXPRT_FRDCHAR
; writeln
        LEA   AX, _VXPK_17
        MOV   SI, AX
...
_VXP_F  DB  132 DUP(0)
  DB  258 DUP(0)
_VXPRT_STATUS  DW  0
_VXPK_3  DB  'Test I/O',0
_VXPK_4  DB  'Valeur : ',0
_VXPK_5  DB  'test_output.txt',0
_VXPK_7  DB  'Ligne 1',0
_VXPK_8  DB  'Ligne 2',0
_VXPK_9  DB  'Ligne 3',0
_VXPK_10  DB  'Fichier ecrit.',0
_VXPK_11  DB  'test_output.txt',0
_VXPK_17  DB  'Lu : ',0
_VXPK_18  DB  'Test I/O termine.',0
_DATA   ENDS
