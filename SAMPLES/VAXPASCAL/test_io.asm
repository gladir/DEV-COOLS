...
; Source : SAMPLES/VAXPASCAL/test_io.pas
...
; exception: sauvegarder handler parent
        ...
        PUSH   DWORD PTR [_VXPRT_EXCSP]
        PUSH   DWORD PTR [_VXPRT_EXCBP]
        MOV   DWORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_13
        MOV   DWORD PTR [_VXPRT_EXCSP], ESP
        MOV   DWORD PTR [_VXPRT_EXCBP], EBP
; readln
        CALL   _VXPRT_READSTR
        MOV   DWORD PTR [_VXP_LINE], EAX
; writeln
        LEA   EAX, _VXPK_15
        MOV   ESI, EAX
        CALL   _VXPRT_PRINTSTR
...
_VXP_F  DB  132 DUP(0)
_VXP_LINE  DB  260 DUP(0)
_VXPRT_STATUS  DD  0
_VXPK_3  DB  'Test I/O',0
_VXPK_4  DB  'Valeur : ',0
_VXPK_5  DB  'test_output.txt',0
_VXPK_6  DB  'Ligne 1',0
_VXPK_7  DB  'Ligne 2',0
_VXPK_8  DB  'Ligne 3',0
_VXPK_9  DB  'Fichier ecrit.',0
_VXPK_10  DB  'test_output.txt',0
_VXPK_15  DB  'Lu : ',0
_VXPK_16  DB  'Test I/O termine.',0
_DATA   ENDS
        END     _VXPF_MAIN
