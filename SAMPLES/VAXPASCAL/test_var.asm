...
; Source : SAMPLES/VAXPASCAL/test_var.pas
...
; assign a
        MOV   EAX, 10
        MOV   DWORD PTR [_VXP_A], EAX
; assign b
        MOV   EAX, -5
        MOV   DWORD PTR [_VXP_B], EAX
; assign c
        MOV   EAX, 42
...
; varying assign name
        MOV   ESI, EAX
        MOV   EDI, OFFSET _VXP_NAME
        CALL   _VXPRT_VARY_FROM_STR
; assign w
        MOV   EAX, 255
        MOV   DWORD PTR [_VXP_W], EAX
; writeln
        LEA   EAX, _VXPK_5
        MOV   ESI, EAX
        CALL   _VXPRT_PRINTSTR
        MOV   EAX, DWORD PTR [_VXP_A]
