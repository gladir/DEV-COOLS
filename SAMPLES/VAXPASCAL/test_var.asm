...
; Source : SAMPLES\VAXPASCAL\test_var.pas
; ========================================
...
; assign a
        MOV   AX, 10
        MOV   WORD PTR [_VXP_A], AX
; assign b
        MOV   AX, -5
        MOV   WORD PTR [_VXP_B], AX
; assign c
        MOV   AX, 42
        MOV   WORD PTR [_VXP_C], AX
; assign d
        MOV   AX, 1
        MOV   BYTE PTR [_VXP_D], AL
; assign ch
        LEA   AX, _VXPK_3
        MOV   BYTE PTR [_VXP_CH], AL
; assign name
        LEA   AX, _VXPK_4
        MOV   WORD PTR [_VXP_NAME], AX
; assign w
        MOV   AX, 255
        MOV   WORD PTR [_VXP_W], AX
; writeln
        LEA   AX, _VXPK_5
        MOV   SI, AX
        CALL   _VXPRT_PRINTSTR
        MOV   AX, WORD PTR [_VXP_A]
...
_VXP_D  DB  0
_VXP_CH  DB  0
_VXP_NAME  DB  82 DUP(0)
_VXP_PTR  DW  0
_VXP_W  DW  0
_VXPK_3  DB  'A',0
_VXPK_4  DB  'VAX Pascal',0
_VXPK_5  DB  'a = ',0
_VXPK_6  DB  'b = ',0
_VXPK_7  DB  'c = ',0
_VXPK_8  DB  'd = ',0
