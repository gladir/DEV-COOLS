...
; Source : SAMPLES\VAXPASCAL\test_value.pas
; ========================================
...
_VXP_COUNTER  DW  0
_VXP_NAME  DB  22 DUP(0)
_VXP_FLAG  DB  1
_VXPK_1  DB  'init',0
_VXPK_4  DB  'counter = ',0
_VXPK_5  DB  'name    = ',0
_VXPK_6  DB  'flag    = ',0
_VXPK_9  DB  'counter apres +1 = ',0
_DATA   ENDS
