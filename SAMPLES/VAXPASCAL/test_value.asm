...
; Source : SAMPLES/VAXPASCAL/test_value.pas
...
; writeln
        ...
        MOV   EAX, DWORD PTR [_VXP_COUNTER]
...
; assign counter
        ...
        POP   EAX
        ADD   EAX, EBX
        MOV   DWORD PTR [_VXP_COUNTER], EAX
; writeln
        LEA   EAX, _VXPK_7
        MOV   ESI, EAX
        CALL   _VXPRT_PRINTSTR
...
_VXP_COUNTER  DD  0
_VXP_NAME  DB  24 DUP(0)
_VXP_FLAG  DB  1
_VXPK_1  DB  'init',0
_VXPK_4  DB  'counter = ',0
_VXPK_5  DB  'name    = ',0
_VXPK_6  DB  'flag    = ',0
_VXPK_7  DB  'counter apres +1 = ',0
_DATA   ENDS
        END     _VXPF_MAIN
