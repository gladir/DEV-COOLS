...
; Source : SAMPLES\VAXPASCAL\test_label.pas
; ========================================
...
_VXP_I  DW  0
_VXPK_6  DB  'Boucle goto : i = ',0
_VXPK_7  DB  'Ceci ne s''affiche pas',0
_VXPK_8  DB  'Apres goto 200',0
_VXPK_9  DB  'Ceci non plus',0
_VXPK_10  DB  'Programme termine.',0
_DATA   ENDS
