...
; Source : SAMPLES/VAXPASCAL/test_ifcase.pas
...
; assign X
        MOV   EAX, 10
        MOV   DWORD PTR [_VXP_X], EAX
; if
        MOV   EAX, DWORD PTR [_VXP_X]
        PUSH   EAX
        MOV   EAX, 10
        MOV   EBX, EAX
        POP   EAX
...
; assign Y
        MOV   EAX, 5
        MOV   DWORD PTR [_VXP_Y], EAX
; if
        MOV   EAX, DWORD PTR [_VXP_Y]
        PUSH   EAX
        MOV   EAX, 10
        MOV   EBX, EAX
        POP   EAX
...
; exception: sauvegarder handler parent
        ...
        PUSH   DWORD PTR [_VXPRT_EXCSP]
        PUSH   DWORD PTR [_VXPRT_EXCBP]
        MOV   DWORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_15
        MOV   DWORD PTR [_VXPRT_EXCSP], ESP
        MOV   DWORD PTR [_VXPRT_EXCBP], EBP
; writeln
        LEA   EAX, _VXPK_17
...
; exception: sauvegarder handler parent
        ...
        PUSH   DWORD PTR [_VXPRT_EXCSP]
        PUSH   DWORD PTR [_VXPRT_EXCBP]
        MOV   DWORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_18
        MOV   DWORD PTR [_VXPRT_EXCSP], ESP
        MOV   DWORD PTR [_VXPRT_EXCBP], EBP
; writeln
        LEA   EAX, _VXPK_20
...
_VXP_Y  DD  0
_VXP_C  DB  0
_VXPK_6  DB  'IF simple: OK',0
_VXPK_10  DB  'IF/ELSE: FAIL',0
_VXPK_11  DB  'IF/ELSE: OK',0
_VXPK_17  DB  'IF block: OK',0
_VXPK_20  DB  'IF block: FAIL',0
_VXPK_27  DB  'Nested IF: OK',0
_VXPK_28  DB  'Nested IF: FAIL',0
_VXPK_32  DB  'CASE val: FAIL',0
_VXPK_35  DB  'CASE val: OK',0
_VXPK_38  DB  'CASE val: FAIL',0
_VXPK_42  DB  'CASE others: FAIL',0
_VXPK_45  DB  'CASE others: FAIL',0
_VXPK_46  DB  'CASE others: OK',0
_VXPK_50  DB  'CASE otherwise: FAIL',0
_VXPK_51  DB  'CASE otherwise: OK',0
_VXPK_55  DB  'CASE range: FAIL',0
_VXPK_58  DB  'CASE range: OK',0
_VXPK_61  DB  'CASE range: FAIL',0
_VXPK_62  DB  'GOTO: FAIL',0
_VXPK_63  DB  'GOTO numeric: OK',0
_VXPK_64  DB  'GOTO: FAIL',0
_VXPK_65  DB  'GOTO ident: OK',0
_VXPK_66  DB  'Tous les tests TODO 12 OK',0
_DATA   ENDS
        END     _VXPF_MAIN
