...
; Source : SAMPLES/VAXPASCAL/test_except.pas
...
; assign z
        ...
        POP   EAX
        TEST   EBX, EBX
        JZ   _VXPRT_PANIC_DIV0
        CDQ
        IDIV   EBX
        MOV   DWORD PTR [_VXP_Z], EAX
; writeln
        LEA   EAX, _VXPK_5
        MOV   ESI, EAX
        CALL   _VXPRT_PRINTSTR
        MOV   EAX, DWORD PTR [_VXP_Z]
...
; exception handler
        ...
        POP   DWORD PTR [_VXPRT_EXCSP]
        POP   DWORD PTR [_VXPRT_EXCHDL]
        CMP   DWORD PTR [_VXPRT_EXCCODE], 3
        JNE   _VXPL_6
; exception: sauvegarder handler parent
        PUSH   DWORD PTR [_VXPRT_EXCHDL]
        PUSH   DWORD PTR [_VXPRT_EXCSP]
        PUSH   DWORD PTR [_VXPRT_EXCBP]
        MOV   DWORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_7
        MOV   DWORD PTR [_VXPRT_EXCSP], ESP
        MOV   DWORD PTR [_VXPRT_EXCBP], EBP
; writeln
        LEA   EAX, _VXPK_9
...
_VXPL_8:
        JMP   _VXPL_4
_VXPL_6:
; resignal implicite (pas de ANYOTHER)
        MOV   ESP, DWORD PTR [_VXPRT_EXCSP]
        MOV   EBP, DWORD PTR [_VXPRT_EXCBP]
        JMP   DWORD PTR [_VXPRT_EXCHDL]
_VXPL_4:
...
; exception: sauvegarder handler parent
        ...
        PUSH   DWORD PTR [_VXPRT_EXCSP]
        PUSH   DWORD PTR [_VXPRT_EXCBP]
        MOV   DWORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_11
        MOV   DWORD PTR [_VXPRT_EXCSP], ESP
        MOV   DWORD PTR [_VXPRT_EXCBP], EBP
; signal(user_error)
        MOV   DWORD PTR [_VXPRT_EXCCODE], 200
        MOV   ESP, DWORD PTR [_VXPRT_EXCSP]
        MOV   EBP, DWORD PTR [_VXPRT_EXCBP]
        JMP   DWORD PTR [_VXPRT_EXCHDL]
; writeln
...
; exception handler
        ...
        POP   DWORD PTR [_VXPRT_EXCSP]
        POP   DWORD PTR [_VXPRT_EXCHDL]
        CMP   DWORD PTR [_VXPRT_EXCCODE], 200
        JNE   _VXPL_14
; writeln
        LEA   EAX, _VXPK_15
        MOV   ESI, EAX
...
_VXP_Z  DD  0
_VXPK_5  DB  'z = ',0
_VXPK_9  DB  'Erreur : division par zero interceptee',0
_VXPK_10  DB  'Apres exception : x = ',0
_VXPK_13  DB  'Ceci ne devrait pas s''afficher',0
_VXPK_15  DB  'Signal user_error intercepte',0
_VXPK_16  DB  'Autre erreur',0
_VXPK_19  DB  'Bloc normal : x = ',0
_VXPK_20  DB  'Programme termine normalement.',0
_DATA   ENDS
        END     _VXPF_MAIN
