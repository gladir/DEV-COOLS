...
; Source : SAMPLES\VAXPASCAL\test_except.pas
; ========================================
...
; assign z
        ...
        CWD
        IDIV   BX
        MOV   WORD PTR [_VXP_Z], AX
; writeln
        LEA   AX, _VXPK_5
        MOV   SI, AX
        CALL   _VXPRT_PRINTSTR
        MOV   AX, WORD PTR [_VXP_Z]
...
; exception: sauvegarder handler parent
        ...
        PUSH   WORD PTR [_VXPRT_EXCSP]
        PUSH   WORD PTR [_VXPRT_EXCBP]
        MOV   WORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_11
        MOV   WORD PTR [_VXPRT_EXCSP], SP
        MOV   WORD PTR [_VXPRT_EXCBP], BP
; signal
        MOV   AX, 200
...
; exception handler
        ...
        POP   WORD PTR [_VXPRT_EXCSP]
        POP   WORD PTR [_VXPRT_EXCHDL]
        CMP   WORD PTR [_VXPRT_EXCCODE], 200
        JNE   _VXPL_14
; writeln
        LEA   AX, _VXPK_15
        MOV   SI, AX
...
; exception: sauvegarder handler parent
        ...
        PUSH   WORD PTR [_VXPRT_EXCSP]
        PUSH   WORD PTR [_VXPRT_EXCBP]
        MOV   WORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_17
        MOV   WORD PTR [_VXPRT_EXCSP], SP
        MOV   WORD PTR [_VXPRT_EXCBP], BP
; assign x
        MOV   AX, 42
