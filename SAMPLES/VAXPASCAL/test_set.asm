...
; Source : SAMPLES/VAXPASCAL/test_set.pas
...
; set constructor
        ...
        LEA   EAX, _VXPRT_STMP1
        MOV   ESI, EAX
        MOV   EDI, OFFSET _VXP_S2
        CALL   _VXPRT_SET_COPY
; assign s3
        MOV   EAX, OFFSET _VXP_S1
        PUSH   EAX
        MOV   EAX, OFFSET _VXP_S2
        MOV   EBX, EAX
        POP   EAX
; set union
        MOV   ESI, EAX
        ...
        MOV   ESI, EAX
        MOV   EDI, OFFSET _VXP_S3
        CALL   _VXPRT_SET_COPY
; writeln
        LEA   EAX, _VXPK_3
        MOV   ESI, EAX
        CALL   _VXPRT_PRINTSTR
        MOV   EAX, OFFSET _VXP_S3
; CARD(set)
        MOV   ESI, EAX
