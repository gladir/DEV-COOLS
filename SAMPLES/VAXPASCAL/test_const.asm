...
; exception: sauvegarder handler parent
        ...
        MOV   WORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_4
...
_VXPK_1  DB  'Bonjour',0
_VXPK_2  DB  'FF',0
_VXPK_3  DB  '77',0
_VXPK_6  DB  'PI_APPROX = ',0
_VXPK_7  DB  'MAX_SIZE  = ',0
_VXPK_8  DB  'GREETING  = ',0
_VXPK_9  DB  'HEX_VAL   = ',0
_VXPK_10  DB  'OCT_VAL   = ',0
_VXPK_11  DB  'FLAG      = ',0
_DATA   ENDS
