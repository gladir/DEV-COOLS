...
; Source : SAMPLES\VAXPASCAL\test_pointer.pas
; ========================================
...
; new
        MOV   AX, 2
        CALL   _VXPRT_NEW
        MOV   WORD PTR [_VXP_P], AX
; assign p^
        MOV   AX, 42
        MOV   BX, WORD PTR [_VXP_P]
        MOV   WORD PTR [BX], AX
; writeln
        LEA   AX, _VXPK_3
        MOV   SI, AX
        CALL   _VXPRT_PRINTSTR
        MOV   AX, WORD PTR [_VXP_P]
        MOV   BX, AX
        MOV   AX, WORD PTR [BX]
...
; new
        MOV   AX, 6
        CALL   _VXPRT_NEW
        MOV   WORD PTR [_VXP_N1], AX
; new
        MOV   AX, 6
        CALL   _VXPRT_NEW
        MOV   WORD PTR [_VXP_N2], AX
; writeln
        LEA   AX, _VXPK_4
        MOV   SI, AX
        CALL   _VXPRT_PRINTSTR
        MOV   AX, WORD PTR [_VXP_N1]
        MOV   BX, AX
        MOV   AX, WORD PTR [BX]
        CALL   _VXPRT_NUMTOSTR
        MOV   SI, OFFSET _VXPRT_NUMBUF
...
; writeln
        ...
        CALL   _VXPRT_PRINTSTR
; assign addr
        MOV   AX, OFFSET _VXP_N1
        MOV   WORD PTR [_VXP_ADDR], AX
; writeln
        LEA   AX, _VXPK_6
        MOV   SI, AX
        CALL   _VXPRT_PRINTSTR
        MOV   AX, WORD PTR [_VXP_ADDR]
        CALL   _VXPRT_NUMTOSTR
        MOV   SI, OFFSET _VXPRT_NUMBUF
        CALL   _VXPRT_PRINTSTR
        MOV   SI, OFFSET _VXPRT_CRLF
