...
; Source : SAMPLES\VAXPASCAL\test_procvar.pas
; ========================================
...
_VXPL_1:
        ...
        POP   BP
        RET   2
_VXPF_DOUBLE_IT   ENDP


; --- triple_it ---
_VXPF_TRIPLE_IT   PROC NEAR
        PUSH   BP
        MOV   BP, SP
        SUB   SP, 2
        PUSH   SI
...
; exception: sauvegarder handler parent
        ...
        PUSH   WORD PTR [_VXPRT_EXCSP]
        PUSH   WORD PTR [_VXPRT_EXCBP]
        MOV   WORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_5
        MOV   WORD PTR [_VXPRT_EXCSP], SP
        MOV   WORD PTR [_VXPRT_EXCBP], BP
; assign retval triple_it
        MOV   AX, WORD PTR [BP+4]
        PUSH   AX
        MOV   AX, 3
        MOV   BX, AX
...
_VXPL_4:
        ...
        POP   BP
        RET   2
_VXPF_TRIPLE_IT   ENDP


; --- apply ---
_VXPF_APPLY   PROC NEAR
        PUSH   BP
        MOV   BP, SP
        SUB   SP, 2
        PUSH   SI
...
; exception: sauvegarder handler parent
        ...
        MOV   WORD PTR [_VXPRT_EXCBP], BP
; call apply
        MOV   AX, OFFSET _VXPF_DOUBLE_IT
        PUSH   AX
        MOV   AX, 5
        PUSH   AX
        CALL   _VXPF_APPLY
; call apply
        MOV   AX, OFFSET _VXPF_TRIPLE_IT
        PUSH   AX
        MOV   AX, 5
        PUSH   AX
        CALL   _VXPF_APPLY
...
_VXPK_10  DB  'apply(f, ',0
_VXPK_11  DB  ') = ',0
_VXPK_14  DB  'Test proc var termine.',0
_DATA   ENDS
