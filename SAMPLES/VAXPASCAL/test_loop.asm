...
; Source : SAMPLES\VAXPASCAL\test_loop.pas
; ========================================
...
; for
        ...
        MOV   AX, 10
        MOV   WORD PTR [_VXPL_3], AX
_VXPL_4:
        MOV   AX, WORD PTR [_VXP_I]
        CMP   AX, WORD PTR [_VXPL_3]
        JG   _VXPL_5
; assign sum
...
; for
        ...
        MOV   WORD PTR [_VXP_I], AX
        MOV   AX, 20
        MOV   WORD PTR [_VXPL_9], AX
        MOV   AX, 2
        MOV   WORD PTR [_VXPL_10], AX
_VXPL_11:
        MOV   AX, WORD PTR [_VXP_I]
        CMP   AX, WORD PTR [_VXPL_9]
        JG   _VXPL_12
; write
        MOV   AX, WORD PTR [_VXP_I]
        CALL   _VXPRT_NUMTOSTR
...
; exception: sauvegarder handler parent
        ...
        PUSH   WORD PTR [_VXPRT_EXCSP]
        PUSH   WORD PTR [_VXPRT_EXCBP]
        MOV   WORD PTR [_VXPRT_EXCHDL], OFFSET _VXPL_24
        MOV   WORD PTR [_VXPRT_EXCSP], SP
        MOV   WORD PTR [_VXPRT_EXCBP], BP
; assign sum
        MOV   AX, WORD PTR [_VXP_SUM]
