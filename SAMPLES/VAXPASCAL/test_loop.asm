...
; Source : SAMPLES/VAXPASCAL/test_loop.pas
...
; for
        ...
        MOV   DWORD PTR [_VXP_I], EAX
        MOV   EAX, 1
        MOV   DWORD PTR [_VXPL_16], EAX
_VXPL_17:
        MOV   EAX, DWORD PTR [_VXP_I]
        CMP   EAX, DWORD PTR [_VXPL_16]
        JL   _VXPL_18
; write
        MOV   EAX, DWORD PTR [_VXP_I]
        CALL   _VXPRT_PRINTINT
...
_VXP_SUM  DD  0
_VXPL_3  DD  0
_VXPK_7  DB  'Sum 1..10 = ',0
_VXPK_8  DB  'Nombres impairs :',0
_VXPK_14  DB  ' ',0
_VXPL_9  DD  0
_VXPL_10  DD  0
_VXPK_15  DB  'Decompte :',0
_VXPK_20  DB  ' ',0
_VXPL_16  DD  0
_VXPK_26  DB  'Sum 1..100 = ',0
_VXPK_29  DB  ' ',0
_VXPK_36  DB  ' ',0
_DATA   ENDS
        END     _VXPF_MAIN
