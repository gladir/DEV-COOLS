...
<ul>	
	<li>Lequel supporte, les langages de programmations comme ABAP/4, Ada, Assembleur (8086, 80386, 68000), C, C#, Java, Lua, Pascal, Python, Visual Basic 6, Visual Basic .NET, X++,...</li>
